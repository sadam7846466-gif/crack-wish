                ...
                children: [
                      ...
                      onPressed: () async {
                        ...
                        final bool? confirm = await showCupertinoDialog<bool>(
                          ...
                          builder: (BuildContext context) => CupertinoAlertDialog(
                            title: Text(lang == 'tr' ? 'Çıkış Yap' : 'Log Out'),
                            content: Text(lang == 'tr' ? 'Evrenden ayrılmak istediğine emin misin?' : 'Are you sure you want to log out?'),
                            actions: <Widget>[
                              ...
                              CupertinoDialogAction(
                                ...
                                child: Text(lang == 'tr' ? 'Evet, Çıkış Yap' : 'Yes, Log Out'),
                        ...
                        // Kök dizinden itibaren çıkış işlemi
                        if (context.mounted) {
                        ...
                        // Clear caches and local session
                        final prefs = await SharedPreferences.getInstance();
                        await prefs.clear();
                        ...
                        if (context.mounted) {
                           // Route back to Splash/Onboarding by replacing entire stack
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () async {
                        HapticFeedback.heavyImpact();
                        await StorageService.resetDailies();
                        
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(lang == 'tr' ? 'Günlük limitler sıfırlandı!' : 'Daily limits reset!'),
                              backgroundColor: Colors.green,
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
                          // Cihaz güncellensin diye bir süre bekleyip anasayfaya veya popa
                      ...
                      child: Text(
                        lang == 'tr' ? 'Günlük Limitleri Sıfırla (BETA)' : 'Reset Dailies (BETA)',
                        style: TextStyle(
