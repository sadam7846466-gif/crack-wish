        ...
        body: Stack(
          ...
          Positioned(
            ...
            child: GuidanceBookletButton(
              ...
              items: const [
                GuidanceItem(
                  titleTr: 'Duygusal Farkındalık',
                  titleEn: 'Emotional Awareness',
                  descTr: 'Ruh halini seçmek hislerini somutlaştırır; bu, içsel dengeni bulmanın ve öz-farkındalığın ilk adımıdır.',
                  descEn: 'Choosing your mood makes your feelings concrete; this is the first step finding inner balance and self-awareness.',
                  icon: Icons.psychology_outlined,
                ),
                GuidanceItem(
                  titleTr: 'Kozmik Frekans',
                  titleEn: 'Cosmic Frequency',
                  descTr: 'Mod tekerinden seçtiğin her duygunun bir frekansı vardır. Ekranın aurası doğrudan senin hislerinle uyumlanır.',
                  descEn: 'Every emotion you pick on the wheel carries a frequency. The screen\'s aura aligns directly with your feelings.',
                  icon: Icons.auto_awesome_outlined,
                ),
                GuidanceItem(
                  titleTr: 'Nasıl Kullanmalı?',
                  titleEn: 'How to Use?',
                  descTr: 'Sadece çarkı çevirip o anki ruh halini en iyi yansıtan ifadeyi seç. Duygunu yargılama, sadece hisset ve kabul et.',
                  descEn: 'Simply spin the wheel and pick the expression that best reflects your mood. Do not judge your feeling, just feel and accept it.',
