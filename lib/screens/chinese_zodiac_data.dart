...
class ChineseZodiacData {
  ...
  static Map<String, dynamic> getDayFortune(int animalIndex, DateTime date) {
    ...
    if (rng < 15) {
      ...
      challengePool = [
        'Bugün cesur bir adım at — ertelediğin o şeyi yap',
        'Bir hayalini birine sesli söyle',
        'Yeni bir şey dene — konfor alanını genişlet',
        'Bugünkü en büyük başarını not al ve kutla',
        'Bugün biri için beklenmedik bir güzellik yap',
        'En cesur fikrine bugün bir adım at',
        'Kendine lüks bir ödül ver — hak ediyorsun',
        'Bugün bir liderin tavrıyla hareket et',
        'Uzun zamandır ertelediğin bir telefonu bugün aç',
        'Hayalindeki projenin ilk satırını bugün yaz',
        'Bugün birini samimiyetle takdir et — yüz yüze',
        'Hiç gitmediğin bir yere bugün git',
        'Öğrenmeyi istediğin bir konunun ilk dersini bugün al',
        'Kendine bir mektup yaz — 1 yıl sonra okumak üzere',
        'Bugün birinden yardım iste — güçlü olmak bazen bunu gerektirir',
        'Sosyal medyada değil, gerçek hayatta bir bağlantı kur',
        'Bugün seni heyecanlandıran bir plan yap ve tarih koy',
        'Eski bir hobine geri dön — bugün sadece 15 dakika yeter',
        'Tanımadığın biriyle sohbet başlat',
        'Bugün bir sınırını kaldır — "yapamam" dediğin bir şeyi dene',
        'Sevdiğin birine sürpriz bir hediye al',
        'Bugün normalde seçmeyeceğin bir şeyi seç — farklı bir yol, yemek veya müzik',
        'Bir başarını kutlamak için kendine güzel bir akşam organize et',
        'Bugün birine ilham verici bir mesaj gönder',
        'Ertelediğin o alışverişi, randevuyu veya kaydı bugün yap',
        'Bugün iş dışında seni mutlu eden bir aktiviteye zaman ayır',
        'Geçmişte vazgeçtiğin bir fikri yeniden değerlendir',
        'Bugün günlük rutinini tamamen değiştir — farklı bir düzen dene',
        'Birine bugün "seninle gurur duyuyorum" de',
        'Kendine bugün büyük bir hedef koy ve ilk adımını at',
      ];
      ...
      challengePool = [
        'Sevdiğin birine teşekkür mesajı gönder',
        'Bugün tanımadığın birine gülümse',
        'Bir yabancıya iltifat et',
        '3 şey yaz: bugün minnettar olduğun',
        'Eski bir arkadaşını ara ve hal hatır sor',
        'Bugün birinin gününü güzelleştir',
        'Sevdiğin bir mekâna git ve anın tadını çıkar',
        'Bir yakınına el yazısıyla not bırak',
        'Bugün sevdiğin bir şarkıyı birine gönder',
        'Aileden birine sarıl ve onu ne kadar sevdiğini söyle',
        'Bugün yeni bir tarif dene ve birini davet et',
        'Bir çicek al — kendine veya birine',
        'Bugün gün batımını izle',
        'Eskiden severken bıraktığın bir aktiviteyi tekrar dene',
        'Bugün dışarıda kahve iç ve etrafı gözlemle',
        'Bir arkadaşına eski bir anınızı hatırlatan bir fotoğraf gönder',
        'Bugün normalde yapmadığın bir nezaket göster',
        'Sevdiğin birini bugün yemeğe davet et',
        'Bir kitapçıya gir ve rastgele bir kitap seç',
        'Bugün güzel bir anın fotoğrafını çek ve sakla',
        'Birinin yükünü bugün hafiflet — küçük bir yardım yeterli',
        'Bugün yeni bir müzik türü keşfet',
        'Sevdiğin bir mekânda tek başına keyifli vakit geçir',
        'Bir yakınına bugün sürpriz bir tatlI al',
        'Doğada yürü ve zihnini temizle',
        'Bugün cep telefonunu kapat ve bir saat gerçek sohbet et',
        'Eski fotoğraflarına bak ve güzel anıları hatırla',
        'Komşuna veya çalışma arkadaşına bir kahve ısmarla',
        'Bugün gökyüzüne bak ve bir dilek tut',
        'Uzun zamandır gitmediğin bir parkı veya sokağı keşfet',
      ];
      ...
      challengePool = [
        'Bugün kendine güzel bir fincan çay hazırla ve keyfini çıkar',
        '5 dakika sessizce otur ve nefesine odaklan',
        'Sevdiğin müziği gözlerin kapalı dinle',
        'Doğada 10 dakika sessiz yürüyüş yap',
        'Bugün yapacaklar listenden 1 şeyi sil — rahatla',
        'Bir sayfaya bugünkü düşüncelerini yaz',
        'Pencereden gökyüzünü 5 dakika izle',
        'Sevdiğin bir yemeği yavaşça ve tadını çıkararak ye',
        'Odanı temizle ve düzene sok — dış düzen iç huzur getirir',
        'Bugün 20 dakika kitap oku',
        'Telefonunu 1 saat kenara koy ve etrafındakilere odaklan',
        'Yarım bıraktığın bir işi bugün bitir',
        'Bugün günlük yaz — sadece 5 cümle yeterli',
        'Akşam yatmadan önce yarın için 3 hedef belirle',
        'Bugün sağlıklı bir şey pişir',
        'Bir podcast veya belgesel izle — yeni bir şey öğren',
        'Masandaki dağınıklığı topla',
        'Bugün bol su iç — vücuduna iyi bak',
        'Bir yakınına "nasılsın" diye sor ve gerçekten dinle',
        'Bugün 10 dakika esneme hareketleri yap',
        'Yatmadan önce ekranları kapat ve sessizce dinlen',
        'Bugün bir şeyi ilk kez yapmayı dene',
        'Eski eşyaların arasından ihtiyacın olmayanları ayıkla',
        'Bugün sıradan bir anın fotoğrafını çek — günlerin ne kadar değerli olduğunu hatırla',
        'Bir bardak su al ve camın önünde 5 dakika dışarıyı izle',
        'Bugün planlamadan spontane bir şey yap',
        'Bir liste yap: Bu ay başarmak istediğin 3 şey',
        'Bugün erken kalk ve sabahın sessizliğini yaşa',
        'Akşam yemeğini telefonsuz ye',
        'Bugün küçük de olsa bir iyilik yap — kapıyı tut, yol ver, gülümse',
      ];
      ...
      challengePool = [
        'Telefonunu 1 saat kenara koy ve sessizliğin tadını çıkar',
        '5 dakika derin nefes egzersizi yap',
        'Bugün için 1 şey yaz: bırakman gereken',
        'Kendine güzel bir şey söyle — sesli olarak',
        'Bu gece erken yat ve kaliteli uyku al',
        'Stres yapan 1 şeyi bugünlük bırak',
        'Sıcak bir duş al ve zihnini temizle',
        'Sevdiğin bir anıyı düşün ve gülümse',
        'Bugün sosyal medyaya bakmadan bir gün geçir',
        'Seni rahatsız eden bir konuyu kâğıda dök',
        'Bugün sadece öncelikli 3 işe odaklan',
        'Bir bardak sıcak süt veya çay iç ve erken yat',
        'Bugün kimseyle tartışmamaya karar ver',
        'Kendine şu soruyu sor: Bugün kontrolümde olan ne var?',
        'Bugün 15 dakika sessiz bir yerde otur',
        'Gereksiz bir alışverişi iptal et — gerçekten ihtiyacın var mı?',
        'Bugün şikayetlenme — sadece çözümlere odaklan',
        'Bir yürüyüş yap ve düşüncelerini toparla',
        'Yatmadan önce günün en iyi anını hatırla',
        'Bugün bir şeyden vazgeç — bırakmak da güçtür',
        'Seni yoran bir ilişkiye sınır koy',
        'Bugün açık havada 10 dakika geçir',
        'Bir şey yapmadan önce 3 kere düşün',
        'Bugün günü 3 kelimeyle özetle ve bunu not et',
        'Olumsuz bir düşünceyi bugün olumluya çevir',
        'Kendine nazik ol — bugün mükemmel olmak zorunda değilsin',
        'Bu akşam telefonunu odandan çıkar ve kitap oku',
        'Bugün sabırlı ol — tepki vermeden önce 10 sn bekle',
        'Bir günlük detoks yap: şeker, haber veya dedikodu',
        'Bugün sadece şu ana odaklan — geçmişi ve geleceği bırak',
      ];
      ...
      challengePool = [
        'Gün batımını izle ve bir dilek tut',
        'Rahatlatıcı bir banyo yap veya sıcak çay iç',
        'Bugün sadece 1 iş yap, ama onu iyi yap',
        'Sevdiğin bir anıyı hatırla ve gülümse',
        'Kendine sarıl — bazen en iyi destek sensin',
        'Favori battaniyene sarıl ve film izle',
        'Bugün "hayır" deme cesaretini göster',
        'Sessizce 3 şey say: hayatında iyi olan',
        'Sevdiğin bir şarkıyı aç ve bırak ruhunu sarsın',
        'Bugün sadece bugne odaklan — yarını düşünme',
        'Birini ara — sesini duymak iyi gelecek',
        'Sıcak bir içecek hazırla ve camdan dışarıyı izle',
        'Bugün kendini suçlama — zor günler herkesin başına gelir',
        'En rahat kıyafetlerini giy ve kendine iyi bak',
        'Kısa bir yürüyüş yap — temiz hava mucize yapar',
        'Sevdiğin bir çizgi film veya komedi izle',
        'Bugün erken yat — uyku en iyi ilaçtır',
        'Geçmişteki bir başarını hatırla — o güç hala sende',
        'Bir sayfaya bugün hissettiklerini yaz — dökmek rahatlatir',
        'Sevdiğin bir yemeği sıpariş et — bugün bunu hak ediyorsun',
        'Derin bir nefes al ve şunu söyle: "Bu da geçecek"',
        'Bugün hiçbir şey yapmamak da tamam — dinlen',
        'Eski güzel fotoğraflarına bak ve gülümse',
        'Telefonundaki bildirimlerı kapat ve sessizliğin tadını çıkar',
        'Bugün bir yakinine sarıl — söze gerek yok',
        'Sevdiğin bir parfume sık ve kendini şımart',
        'Bugün sadece güzel şeyler düşün — olumsuza yer verme',
        'Rahatlatici müzik aç ve gözlerini kapat',
        'Kendine şunu hatırlat: Dağları aşan biri olduğunu',
        'Bugün ne kadar yol geldiğini düşün ve gurur duy',
      ];
