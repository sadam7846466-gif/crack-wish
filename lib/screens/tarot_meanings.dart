...
const Map<int, CardMeaning> cardMeanings = {
  ...
  22: CardMeaning(id: 22, themeTr: 'Duygusal bolluk, yeni aşk, ruhani hediye', themeEn: 'Emotional abundance, new love, spiritual gift', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Gökyüzünden uzanan gizemli bir el sana altın bir kupa sundu ve o kupadan beş saf su akışı döküldü. Kalbine ilk kez dokunan o duygu, ruhunu sonsuza dek değiştirdi.',
  ...
  23: CardMeaning(id: 23, themeTr: 'Karşılıklı bağ, ortaklık, derin çekim', themeEn: 'Mutual bond, partnership, deep attraction', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'İki kişi birbirinin gözüne bakarak kupalarını buluşturdu. Caduceus asası ve kanatlı aslan başı bu bağı kutsal ilan etti. O karşılıklı söz hâlâ geçerliliğini koruyor.',
    pastEn: 'Two people met each others gaze and clinked their cups. The Caduceus staff and winged lion head declared this bond sacred. That mutual promise still holds.',
    ...
    directionTr: 'Kupanı kaldır ve karşındakine uzat. Gerçek bağ eşit paylaşımdadır. Korkularını bırak, o köprüyü geç.',
  ...
  24: CardMeaning(id: 24, themeTr: 'Kutlama, dostluk, topluluk neşesi', themeEn: 'Celebration, friendship, communal joy', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Üç dost kupalarını havaya kaldırıp dans etti. Etraflarındaki meyveler ve çiçekler bu birlikteliğin bereketini simgeliyordu. O kutlama senin ruhuna kazındı.',
  ...
  25: CardMeaning(id: 25, themeTr: 'İç sıkıntısı, kaçırılan fırsat, bezginlik', themeEn: 'Apathy, missed opportunity, discontent', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Ağacın altında kollarını kavuşturup oturuyordun. Önündeki üç kupaya bakıyordun ama arkandan uzanan gizemli el sana dördüncü bir kupa sunuyordu ve sen fark etmedin.',
  ...
  26: CardMeaning(id: 26, themeTr: 'Kayıp, hayal kırıklığı, umut', themeEn: 'Loss, disappointment, remaining hope', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Siyah pelerinli figür, devrilmiş üç kupanın önünde yas tutuyordu. Dökülen kırmızı şarap gibi kaybettiğin şeyler seni derin bir üzüntüye gömdü. Ama arkadaki iki dolu kupa duruyor.',
  ...
  27: CardMeaning(id: 27, themeTr: 'Nostalji, masumiyet, çocukluk anıları', themeEn: 'Nostalgia, innocence, childhood memories', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Küçük bir çocuk, çiçeklerle dolu bir kupayı büyük çocuğa uzattı. Eski evin bahçesindeki o sıcak anılar gibi, geçmişteki masumiyetin seni korudu.',
  ...
  28: CardMeaning(id: 28, themeTr: 'Hayal, seçenek bolluğu, yanılsama', themeEn: 'Fantasy, abundant choices, illusion', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Yedi kupa bulutların içinden belirdi — her biri farklı bir vaat taşıyordu: servet, güzellik, zafer... Ama hepsi birer gölge miydi yoksa gerçek mi, bunu hiç anlayamadın.',
  ...
  29: CardMeaning(id: 29, themeTr: 'Arayış, geride bırakma, ruhani yolculuk', themeEn: 'Search, leaving behind, spiritual journey', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.ending,
    pastTr: 'Kırmızı pelerinli figür, düzenli dizilmiş sekiz kupaya sırtını döndü ve dağlara doğru yürümeye başladı. Tutulma altındaki ay, bu ayrılığı kutsal kıldı.',
  ...
  30: CardMeaning(id: 30, themeTr: 'Dilek gerçekleşmesi, tatmin, bolluk', themeEn: 'Wish fulfillment, satisfaction, abundance', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Kollarını kavuşturmuş, memnun figür, arkasında gökkuşağı gibi dizilmiş dokuz altın kupanın önünde gülümsedi. O an, her şeyin yolunda olduğunu hissettiğin en saf andı.',
  ...
  31: CardMeaning(id: 31, themeTr: 'Aile mutluluğu, duygusal tamlık, huzur', themeEn: 'Family happiness, emotional completeness, peace', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Gökyüzünde parlayan gökkuşağının içindeki on kupa, aile figürlerinin üzerine sonsuz bir bereket yağdırdı. Çocuklar dans etti, çift kucaklaştı. O mutluluk anı ebediydi.',
  ...
  32: CardMeaning(id: 32, themeTr: 'Duygusal mesaj, yaratıcı ilham, sürpriz', themeEn: 'Emotional message, creative inspiration, surprise', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Genç bir haberci kupasından çıkan küçük bir balığa şaşkınlıkla baktı. O beklenmedik mesaj, senin duygusal uyanışının ilk kıvılcımıydı.',
  ...
  33: CardMeaning(id: 33, themeTr: 'Romantik teklif, şövalye ruhu, zarif yaklaşım', themeEn: 'Romantic offer, chivalrous spirit, graceful approach', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Beyaz atının üzerinde sakin nehrin kıyısında ilerleyen şövalye, kupasını nazikçe uzattı. O zarif ve samimi yaklaşım, kalbine dokunmuştu.',
  ...
  34: CardMeaning(id: 34, themeTr: 'Sezgisel bilgelik, empatik güç, duygusal derinlik', themeEn: 'Intuitive wisdom, empathic power, emotional depth', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Deniz kenarındaki tahtında oturan kraliçe, kapalı süslemeli kupasına derin derin baktı. Onun sezgisel gücü gibi, sen de bir zamanlar iç sesini kusursuz duyabiliyordun.',
  ...
  35: CardMeaning(id: 35, themeTr: 'Duygusal olgunluk, sakin liderlik, derin denge', themeEn: 'Emotional maturity, calm leadership, deep balance', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Fırtınalı denizin ortasındaki tahtında oturan kral, bir elinde kupa diğerinde asa, dalgalara aldırmadan hüküm sürdü. Sen de en büyük fırtınalarda bile soğukkanlılığını korudun.',
  ...
  36: CardMeaning(id: 36, themeTr: 'Yaratıcı kıvılcım, yeni girişim, ilham', themeEn: 'Creative spark, new venture, inspiration', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.beginning,
    pastTr: 'Bulutlardan uzanan güçlü bir el sana filizlenen bir asa verdi. O asanın ucundaki yapraklar, senin yaratıcı ateşinin ilk kıvılcımıydı. Bir şeye başladın ve o ateş hâlâ yanıyor.',
  ...
  37: CardMeaning(id: 37, themeTr: 'Planlama, vizyon, keşif arzusu', themeEn: 'Planning, vision, desire for discovery', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Kalenin tepesinden denize bakan figür, bir elinde dünya küresi diğerinde asa tutuyordu. Büyük planlar kurduğun o dönem, bugünün temellerini attı.',
  ...
  38: CardMeaning(id: 38, themeTr: 'Genişleme, ilerleme, ufkun açılması', themeEn: 'Expansion, progress, broadening horizons', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Tepenin üzerinde duran figür, elindeki asayla ufka baktı ve gemilerin yelken açtığını gördü. Attığın adımlar meyvesini vermeye başlamıştı.',
  ...
  39: CardMeaning(id: 39, themeTr: 'Kutlama, yuva, sağlam temel', themeEn: 'Celebration, home, solid foundation', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Dört asadan yapılan takın altında çift dans ediyordu. Çiçek çelenkleri ve arkadaki kale, senin güvenli bir yuva kurduğun o mutlu dönemi simgeliyordu.',
  ...
  40: CardMeaning(id: 40, themeTr: 'Rekabet, sürtüşme, yapıcı çatışma', themeEn: 'Competition, friction, constructive conflict', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Beş genç asalarını birbirine vurarak mücadele ediyordu. Düzensiz ve kaotik görünüyordu ama bu sürtüşme aslında seni biledi ve güçlendirdi.',
    ...
    presentTr: 'Çevrende rekabet kızışıyor. Beş asanın çarpışması gibi farklı sesler, fikirler ve istekler çatışıyor. Kaos gibi görünen bu ortam, aslında seni büyütüyor.',
    ...
    directionTr: 'Çatışmadan kaçma, onu yönet. Beş asanın dansı bir savaş değil, bir antrenman. Rakiplerinden öğren ve kendi tarzını bul.',
  ...
  41: CardMeaning(id: 41, themeTr: 'Zafer, tanınma, başarı taçlanması', themeEn: 'Victory, recognition, crowning success', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.completion,
    pastTr: 'Defne çelengiyle süslenmiş asanı tutan atlı, kalabalığın alkışları arasında zafer yürüyüşü yaptı. O an hak ettiğin tanınmayı aldığın muhteşem andı.',
  ...
  42: CardMeaning(id: 42, themeTr: 'Savunma, direnç, toprak koruma', themeEn: 'Defense, resilience, holding ground', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Tepenin üzerinde tek başına, alttan gelen altı asaya karşı kendi asanla savaştın. Dezavantajlı konumda bile pes etmedin ve yerini korudun.',
  ...
  43: CardMeaning(id: 43, themeTr: 'Hızlı gelişme, momentum, ani hareket', themeEn: 'Rapid development, momentum, swift movement', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Sekiz asa gökyüzünden ok gibi fırladı ve yeşil vadinin üzerinden süzüldü. Her şey o kadar hızlı gelişti ki, nefes bile alamadan yeni bir yere taşındın.',
  ...
  44: CardMeaning(id: 44, themeTr: 'Son direnç, yorgun savaşçı, dayanıklılık', themeEn: 'Last stand, weary warrior, endurance', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Bandajlı başıyla asasına dayanan savaşçı, arkasındaki sekiz asanın oluşturduğu duvarın önünde nöbet tuttu. Yorgun düştün ama asla dizlerinin üstüne çökmedin.',
  ...
  45: CardMeaning(id: 45, themeTr: 'Aşırı yük, sorumluluk, hedefe yakınlık', themeEn: 'Heavy burden, responsibility, nearing the goal', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'On asayı sırtında taşıyarak kasabaya doğru yürüyen figür, omuzlarının ezici ağırlığı altında eğilmişti. Çok fazla sorumluluk üstlendin ama hedefe yaklaştın.',
  ...
  46: CardMeaning(id: 46, themeTr: 'Heyecan, keşif ruhu, genç enerji', themeEn: 'Excitement, spirit of discovery, youthful energy', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.beginning,
    pastTr: 'Genç haberci çöldeki asasına hayranlıkla baktı ve yeni topraklar keşfetmeye ant içti. O ilk heyecan, macera ruhunun doğduğu andı.',
  ...
  47: CardMeaning(id: 47, themeTr: 'Tutkulu atılım, cesur liderlik, macera', themeEn: 'Passionate charge, bold leadership, adventure', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Şövalye alevli atına binip çöller ve piramitler arasından geçti. Hiçbir engel onu durduramadı çünkü tutkusu her şeyden güçlüydü. Sen de öyle yaptın.',
  ...
  48: CardMeaning(id: 48, themeTr: 'Güvenli liderlik, sıcak enerji, manyetik çekim', themeEn: 'Confident leadership, warm energy, magnetic pull', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Aslan süslemeli tahtında oturan kraliçe, bir elinde asası diğerinde ayçiçeği, etrafına pozitif enerji yaydı. Siyah kedisi ayaklarının dibinde dururken herkes onun ışığına koştu.',
    ...
    presentTr: 'Ayçiçeğin güneşe döner gibi insanlar sana yöneliyor. Kraliçenin sıcak kararlılığı sende var. Asanı tut, kedini sev ve tahtından liderlik et.',
  ...
  49: CardMeaning(id: 49, themeTr: 'Vizyoner güç, doğal otorite, stratejik zeka', themeEn: 'Visionary power, natural authority, strategic mind', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Tahtında oturan kral, asasını bir meşale gibi tutarak geleceği gördü. Pelerinindeki semender figürleri ateşten dönüşümü simgeliyordu. Vizyonun gerçeğe dönüştü.',
  ...
  50: CardMeaning(id: 50, themeTr: 'Zihinsel zafer, yeni fikir, berraklık', themeEn: 'Mental victory, new idea, clarity', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.beginning,
    pastTr: 'Bulutlardan uzanan el, altın taçla süslü bir kılıcı sana verdi. Defne dalı ve palmiye yaprakları o zihinsel zaferi süsledi. Aklına gelen o parlak fikir her şeyi değiştirdi.',
  ...
  51: CardMeaning(id: 51, themeTr: 'İkilem, inkâr, ertelenmiş karar', themeEn: 'Dilemma, denial, postponed decision', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Gözleri bağlı kadın, çapraz tuttuğu iki kılıçla denizin önünde oturuyordu. Arkasındaki hilal ay sezgisini çağırıyordu ama sen görmezden geldin.',
  ...
  52: CardMeaning(id: 52, themeTr: 'Kalp kırıklığı, acı gerçek, yas', themeEn: 'Heartbreak, painful truth, grief', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Üç kılıç kırmızı bir kalbin tam ortasından geçti. Yağmur bulutları gözyaşı gibi yağıyordu. O acı veren gerçek seni derinden yaraladı ama içinden geçtin.',
    ...
    directionTr: 'Acıyı kabul et ama onunla evlenme. Üç kılıcı kalbinden çek — iyileşme cesaretle başlar. Yaralar kapanır, izler güçlendirir.',
  ...
  53: CardMeaning(id: 53, themeTr: 'Dinlenme, iyileşme, stratejik bekleme', themeEn: 'Rest, recovery, strategic waiting', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Şövalye kilisede el pençe divan yatıyordu, üç kılıç duvarda asılı, dördüncüsü altında. Vitray pencereden süzülen renkli ışık onu iyileştirdi. Durduğun o dönem seni onardı.',
  ...
  54: CardMeaning(id: 54, themeTr: 'Boş zafer, bedeli ağır kazanç, vicdan', themeEn: 'Hollow victory, costly win, conscience', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Sırıtarak üç kılıcı toplayan figür, geride bıraktığı iki kişinin kılıçlarını da almıştı. Kazandın ama kazanmanın bedeli ağır oldu — arkana bakınca kimse kalmamıştı.',
  ...
  55: CardMeaning(id: 55, themeTr: 'Geçiş, iyileşme yolculuğu, sığınak', themeEn: 'Transition, healing journey, refuge', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Kayıkçı, kadın ve çocuğu altı kılıçla birlikte sakin sulara doğru kürek çekti. Zor bir dönemden çıkıp güvenli kıyılara doğru yol aldın.',
  ...
  56: CardMeaning(id: 56, themeTr: 'Hile, strateji, gizli hamle', themeEn: 'Deception, strategy, hidden move', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Gizlice beş kılıcı toplayan figür, askeri kamptan sessizce uzaklaştı. İki kılıç geride kaldı. Zekice bir hamle mi yoksa aldatma mı — buna sen karar verdin.',
  ...
  57: CardMeaning(id: 57, themeTr: 'Zihinsel hapishane, kendi kendini sınırlama', themeEn: 'Mental prison, self-limitation, restriction', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Bağlanmış ve gözleri örtülü kadın, sekiz kılıcın arasında bataklıkta mahsur kaldı. Ama bağlar gevşekti — sen kendi korkularınla kendini hapsettiin.',
  ...
  58: CardMeaning(id: 58, themeTr: 'Kaygı, kabus, aşırı endişe', themeEn: 'Anxiety, nightmare, excessive worry', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Gece yarısı yatağında doğrulup ellerini yüzüne kapattın. Duvardaki dokuz kılıç karanlıkta parlıyordu. Zihindeki o kabus döngüsü seni uykusuz bıraktı.',
    ...
    presentTr: 'Dokuz kılıç başının üzerinde asılı ve zihnin rahat vermiyor. Her düşünce bir bıçak gibi kesiyor. Ama şunu bil: korkuların gerçek olandan çok daha büyük.',
    presentEn: 'Nine swords hang above your head and your mind gives no peace. Every thought cuts like a blade. But know this: your fears are far greater than reality.',
  ...
  59: CardMeaning(id: 59, themeTr: 'Dip nokta, karanlık son, zoraki yenilenme', themeEn: 'Rock bottom, dark ending, forced renewal', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.ending,
    pastTr: 'Yüzüstü yatan figürün sırtına on kılıç saplandı. Her şey bitmişti — ya da öyle görünüyordu. Ufuktaki altın şafak, bu kapanışın bir yenilenme olduğunu fısıldıyordu.',
  ...
  60: CardMeaning(id: 60, themeTr: 'Meraklı zeka, yeni bakış, cesur söz', themeEn: 'Curious intellect, fresh perspective, bold speech', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.beginning,
    pastTr: 'Rüzgârlı tepede duran genç, kılıcını iki eliyle yukarı kaldırdı. Gökyüzündeki kuşlar onun özgür düşüncesini temsil ediyordu. O ilk cesur sözün her şeyi başlattı.',
    ...
    presentTr: 'Kılıcını yukarı kaldırmışsın ve rüzgâr saçlarını savuruyor. Zihnin keskin, merakın sınırsız. Kuşlar gibi düşüncelerin özgürce uçuyor. Yeni bir fikrin zamanı.',
    presentEn: 'You raise your sword and the wind blows through your hair. Your mind is sharp, your curiosity limitless. Your thoughts fly free like birds. Time for a new idea.',
    directionTr: 'Kılıcını indir ama keskinliğini kaybetme. Genç savaşçının merakıyla dünyaya meydan oku. Cesurca konuş ama dinlemeyi de unutma.',
    directionEn: 'Lower your sword but do not lose its edge. Challenge the world with the young warriors curiosity. Speak boldly, but do not forget to listen.',
  ),
  61: CardMeaning(id: 61, themeTr: 'Hızlı karar, kararlı hamle, ani değişim', themeEn: 'Swift decision, decisive move, sudden change', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Rüzgâr gibi atını süren şövalye, kılıcını havaya kaldırarak düşmanlarına doğru dört nala koştu. Bulutlar ve fırtına onu durduramadı. O ani kararın akışı değiştirdi.',
    ...
    directionTr: 'Tereddüt etme, harekete geç. Şövalyenin kılıcı gibi keskin ve net ol. Ama hız kontrolsüzlük değildir — at sürmeyi bil.',
  ...
  62: CardMeaning(id: 62, themeTr: 'Bağımsız düşünce, duygusal netlik, sert adalet', themeEn: 'Independent thought, emotional clarity, firm justice', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Bulutların üzerindeki tahtında oturan kraliçe, bir eliyle kılıcını kaldırdı diğeriyle uzaklara uzandı. Kelebekler etrafında uçuşurken o acı gerçeği cesurca söyledi.',
  ...
  63: CardMeaning(id: 63, themeTr: 'Entelektüel otorite, adil yönetim, stratejik güç', themeEn: 'Intellectual authority, fair governance, strategic power', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Mavi cüppeli kral tahtında oturarak kılıcını dimdik tuttu. Arkasındaki bulutlar ve kelebekler zihninin hem gücünü hem zarafetini gösteriyordu. Adil ve keskin kararlarınla saygı kazandın.',
  ...
  64: CardMeaning(id: 64, themeTr: 'Maddi fırsat, yeni başlangıç, bereket kapısı', themeEn: 'Material opportunity, new start, abundance gate', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Bulutlardan uzanan el, altın bir sikke sundu. Bahçenin kapısındaki çiçekli kemerin altından o fırsatı aldın ve maddi dünyada ilk adımını attın.',
  ...
  65: CardMeaning(id: 65, themeTr: 'Denge cambazlığı, uyum arayışı, esneklik', themeEn: 'Juggling balance, seeking harmony, flexibility', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Genç jonglör iki sikkeyi sonsuzluk bandıyla çevirirken, arka plandaki dalgalı deniz hayatın inişli çıkışlı dönemini yansıtıyordu. O dengeleme sanatını sen de öğrendin.',
  ...
  66: CardMeaning(id: 66, themeTr: 'Ustalık, takım çalışması, ilk meyveler', themeEn: 'Mastery, teamwork, first fruits', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Usta, kemerli katedralin içinde iki mimarla birlikte çalışıyordu. Planlar incelenirken üç sikke taş kemerden parlıyordu. İş birliğiyle büyük eserler yarattın.',
  ...
  67: CardMeaning(id: 67, themeTr: 'Kontrol tutkusu, güvensizlik, kapalılık', themeEn: 'Control obsession, insecurity, closedness', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Tahtında oturan figür, bir sikkeyi başının üstünde dengelerken diğerlerini ayaklarının altında ve kollarının arasında sıkıca tutuyordu. Kaybetme korkusu seni esir aldı.',
  ...
  68: CardMeaning(id: 68, themeTr: 'Zorluk, dışlanma, gizli destek', themeEn: 'Hardship, exclusion, hidden support', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Karlı yolda yürüyen iki figür, aydınlatılmış katedralin vitray penceresinin önünden geçti. İçerideki sıcaklığı ve desteği göremediler. Sen de zor günlerde yardımı fark etmedin.',
  ...
  69: CardMeaning(id: 69, themeTr: 'Cömertlik, adil paylaşım, karşılıklı yarar', themeEn: 'Generosity, fair sharing, mutual benefit', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Terazisini tutan zengin tüccar, diz çökmüş iki figüre altın sikkeler dağıttı. Sen de bir zamanlar ya veren ya da alan oldun — ve bu denge hayatını şekillendirdi.',
    ...
    directionTr: 'Paylaş ama adil paylaş. Terazinin dengesini bozma. Cömertlik hesapsız olmalı ama sınırsız olmamalı.',
  ...
  70: CardMeaning(id: 70, themeTr: 'Sabır, yatırım, bekleme bilgeliği', themeEn: 'Patience, investment, wisdom of waiting', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Çapa dayanmış çiftçi, asmanın üzerindeki yedi sikkeye baktı ve hasadın zamanını bekledi. Sen de bir zamanlar o sabırlı çiftçi gibi emeğinin meyvesini bekledin.',
  ...
  71: CardMeaning(id: 71, themeTr: 'Özveri, ustalık yolu, detay odaklılık', themeEn: 'Dedication, path to mastery, attention to detail', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Çalışma tezgahında oturan zanaatçı, her sikkeyi aynı titizlikle oydu. Sekiz sikke duvarda asılıydı — her biri bir adımdı ustalık merdiveninde. Özveriyle çalıştın ve becerilerini biledın.',
  ...
  72: CardMeaning(id: 72, themeTr: 'Bağımsızlık, lüks, kendi kendine yetme', themeEn: 'Independence, luxury, self-sufficiency', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Zarif kadın, üzüm bağlarının ortasındaki bahçesinde yürürken elindeki şahini okşadı. Dokuz sikke etrafında parlıyordu. Kendi ellerin ile inşa ettiğin bağımsızlık sana huzur verdi.',
    ...
    directionTr: 'Bağımsızlığını kutla ama yalnızlığa dönüştürme. Şahinin gibi sezgilerini dinle ve bağının meyvelerini paylaş. Gerçek zenginlik paylaşıldığında anlam kazanır.',
  ...
  73: CardMeaning(id: 73, themeTr: 'Kalıcı miras, nesiller arası bağ, köklü refah', themeEn: 'Lasting legacy, generational bond, rooted prosperity', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Kale kapısının önünde üç nesil bir arada duruyordu — yaşlı, yetişkin ve çocuk. On sikke takın her tarafından parlıyordu. Kurduğun miras nesillere aktarıldı.',
  ...
  74: CardMeaning(id: 74, themeTr: 'Yeni öğrenme, pratik hayal, dikkatli adım', themeEn: 'New learning, practical dream, careful step', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Yeşil otların üzerinde yürüyen genç, elindeki sikkeye hayalci bir gözle baktı. Uzaktaki dağlar hedefini, ayaklarının altındaki toprak ise sabırlı adımlarını simgeliyordu.',
  ...
  75: CardMeaning(id: 75, themeTr: 'Sabırlı ilerleme, güvenilir güç, istikrar', themeEn: 'Patient progress, reliable strength, stability', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Ağır adımlarla yürüyen atın üzerindeki şövalye, elindeki sikkeye dikkatle baktı. Tarlalar ve tepeler geçtikçe, sabırlı ama kararlı adımlarla hedefe yaklaştın.',
    ...
    presentTr: 'Atın yavaş ama sağlam adımlarla ilerliyor. Elindeki sikke maddi hedefini simgeliyor. Hızlı değilsin ama güvenilirsin — ve bu seni yarıştan çok daha güçlü kılıyor.',
    presentEn: 'Your horse advances with slow but solid steps. The coin in your hand symbolizes your material goal. You are not fast but reliable — and this makes you far stronger than the race.',
  ...
  76: CardMeaning(id: 76, themeTr: 'Şefkatli bolluk, toprak anası, koruyucu bereket', themeEn: 'Compassionate abundance, earth mother, protective blessing', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Gül bahçesinin ortasındaki tahtında oturan kraliçe, kucağındaki sikkeyi bir bebek gibi sevgiyle tuttu. Tavşan ayaklarının dibinde oturuyordu. Bereket ve şefkatin birleştiği o dönem seni besledi.',
  ...
  77: CardMeaning(id: 77, themeTr: 'Maddi zirve, kalıcı başarı, miras bırakan güç', themeEn: 'Material peak, lasting success, legacy-building power', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Üzüm bağlarıyla çevrili kalesinin önündeki kralın, altın sikkeler cüppesini süslüyordu. Boğa başlı tahtında oturan bu hükümdar, maddi dünyayı fethetmişti. Sen de öyle.',
