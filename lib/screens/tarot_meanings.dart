...
List<CardSymbol> getCardSymbols(int cardId) {
  const majorSymbols = <int, List<CardSymbol>>{
    0: [ // The Fool
      CardSymbol(emoji: '🐕', nameTr: 'Köpek', nameEn: 'Dog', meaningTr: 'Koruyan içgüdülerin', meaningEn: 'Your protective instincts'),
      CardSymbol(emoji: '🏔️', nameTr: 'Uçurum', nameEn: 'Cliff', meaningTr: 'Bilinmeyene cesaretin', meaningEn: 'Courage to leap into unknown'),
      CardSymbol(emoji: '🎒', nameTr: 'Heybe', nameEn: 'Pouch', meaningTr: 'Her şey zaten sende', meaningEn: 'Everything is already within'),
      CardSymbol(emoji: '🌹', nameTr: 'Gül', nameEn: 'Rose', meaningTr: 'Saf niyetle yolculuk', meaningEn: 'Journey with pure intent'),
    ],
    1: [ // The Magician
      CardSymbol(emoji: '♾️', nameTr: 'Sonsuzluk', nameEn: 'Infinity', meaningTr: 'Sınırsız potansiyelin', meaningEn: 'Unlimited potential'),
      CardSymbol(emoji: '🏺', nameTr: 'Elementler', nameEn: 'Elements', meaningTr: 'Tüm araçlar elinde', meaningEn: 'All tools in your hands'),
      CardSymbol(emoji: '🪄', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'İlahi enerji çekiyorsun', meaningEn: 'Channeling divine energy'),
    ],
    2: [ // The High Priestess
      CardSymbol(emoji: '🍇', nameTr: 'Perde', nameEn: 'Veil', meaningTr: 'Gizli bilginin kapısı', meaningEn: 'Gate of hidden knowledge'),
      CardSymbol(emoji: '🏛️', nameTr: 'Sütunlar', nameEn: 'Pillars', meaningTr: 'Aydınlık-karanlık dengesi', meaningEn: 'Dark and light balance'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Sezgi gücün dorukta', meaningEn: 'Your intuition peaks'),
      CardSymbol(emoji: '📜', nameTr: 'Parşömen', nameEn: 'Scroll', meaningTr: 'Açılmamış sırlar', meaningEn: 'Secrets not yet revealed'),
    ],
    3: [ // The Empress
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Kozmik annelik enerjin', meaningEn: 'Your cosmic mothering energy'),
      CardSymbol(emoji: '🌾', nameTr: 'Buğday', nameEn: 'Wheat', meaningTr: 'Şefkatinin hasadı', meaningEn: 'Harvest of compassion'),
      CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Yaratıcılığın akıyor', meaningEn: 'Creativity flows freely'),
    ],
    4: [ // The Emperor
      CardSymbol(emoji: '🪨', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Otoriten sağlam zeminde', meaningEn: 'Your authority on solid ground'),
      CardSymbol(emoji: '🐏', nameTr: 'Koç', nameEn: 'Ram', meaningTr: 'Engelleri kıran iraden', meaningEn: 'Your will that breaks barriers'),
      CardSymbol(emoji: '🔴', nameTr: 'Cüppe', nameEn: 'Robe', meaningTr: 'Tutkuyla yönetim gücün', meaningEn: 'Your power of ruling with passion'),
      CardSymbol(emoji: '🏔️', nameTr: 'Dağlar', nameEn: 'Mountains', meaningTr: 'Liderlik yalnızlık ister', meaningEn: 'Leadership needs solitude'),
    ],
    5: [ // The Hierophant
      CardSymbol(emoji: '⛪', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Bilinç köprüsü', meaningEn: 'Bridge of consciousness'),
      CardSymbol(emoji: '🗝️', nameTr: 'Anahtarlar', nameEn: 'Keys', meaningTr: 'Gizli olanı çözme gücün', meaningEn: 'Power to decode hidden'),
      CardSymbol(emoji: '✋', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Kutsal destekle korunman', meaningEn: 'Divinely protected path'),
    ],
    6: [ // The Lovers
      CardSymbol(emoji: '👼', nameTr: 'Melek', nameEn: 'Angel', meaningTr: 'Üst bilinç desteğin', meaningEn: 'Higher mind supports'),
      CardSymbol(emoji: '🍎', nameTr: 'Ağaç', nameEn: 'Tree', meaningTr: 'Doğru ile arzu arası', meaningEn: 'Between right and desire'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Gerçek aşk gizlenmez', meaningEn: 'True love never hides'),
    ],
    7: [ // The Chariot
      CardSymbol(emoji: '🐱', nameTr: 'Sfenks', nameEn: 'Sphinx', meaningTr: 'Zıt güçleri kontrol et', meaningEn: 'Control opposing forces'),
      CardSymbol(emoji: '⭐', nameTr: 'Yıldız', nameEn: 'Stars', meaningTr: 'Evren seni yönlendiriyor', meaningEn: 'Universe guides you'),
      CardSymbol(emoji: '🛡️', nameTr: 'Zırh', nameEn: 'Armor', meaningTr: 'İradeyle korunman', meaningEn: 'Shielded by willpower'),
    ],
    8: [ // Strength
      CardSymbol(emoji: '🦁', nameTr: 'Aslan', nameEn: 'Lion', meaningTr: 'Ehlileşecek tutkuların', meaningEn: 'Passions to be tamed'),
      CardSymbol(emoji: '♾️', nameTr: 'Sonsuzluk', nameEn: 'Infinity', meaningTr: 'Barışla gelen zafer', meaningEn: 'Victory through peace'),
      CardSymbol(emoji: '🌸', nameTr: 'Çelenk', nameEn: 'Garland', meaningTr: 'Güç yumuşaklıkta', meaningEn: 'Strength in softness'),
    ],
    9: [ // The Hermit
      CardSymbol(emoji: '🏮', nameTr: 'Fener', nameEn: 'Lantern', meaningTr: 'Gerçeği içinde ara', meaningEn: 'Seek truth within'),
      CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Staff', meaningTr: 'Deneyimin güç veriyor', meaningEn: 'Experience gives power'),
      CardSymbol(emoji: '⛰️', nameTr: 'Zirve', nameEn: 'Peak', meaningTr: 'Yalnızlıktaki cevaplar', meaningEn: 'Answers in solitude'),
    ],
    10: [ // Wheel of Fortune
      CardSymbol(emoji: '☸️', nameTr: 'Çark', nameEn: 'Wheel', meaningTr: 'Her iniş çıkışın haberi', meaningEn: 'Every fall heralds a rise'),
      CardSymbol(emoji: '📖', nameTr: 'Sfenks', nameEn: 'Sphinx', meaningTr: 'Merkezde kalmayı bil', meaningEn: 'Know to stay centered'),
      CardSymbol(emoji: '🐍', nameTr: 'Yılan', nameEn: 'Snake', meaningTr: 'Değişime direnmek çeker', meaningEn: 'Resisting change pulls you down'),
    ],
    11: [ // Justice
      CardSymbol(emoji: '⚖️', nameTr: 'Terazi', nameEn: 'Scales', meaningTr: 'Eylemlerin tartılıyor', meaningEn: 'Actions being weighed'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Gerçek iki yönü keser', meaningEn: 'Truth cuts both ways'),
      CardSymbol(emoji: '🟥', nameTr: 'Perde', nameEn: 'Curtain', meaningTr: 'Adaletin sürprizleri var', meaningEn: 'Justice has surprises'),
    ],
    12: [ // The Hanged Man
      CardSymbol(emoji: '🙃', nameTr: 'Duruş', nameEn: 'Pose', meaningTr: 'Ters görmek açar', meaningEn: 'Upside down reveals'),
      CardSymbol(emoji: '💫', nameTr: 'Hale', nameEn: 'Halo', meaningTr: 'Teslimiyetle uyanış', meaningEn: 'Awakening via surrender'),
      CardSymbol(emoji: '🌳', nameTr: 'Ağaç', nameEn: 'Tree', meaningTr: 'Farklı yoldan büyüme', meaningEn: 'Growth the unusual way'),
    ],
    13: [ // Death
      CardSymbol(emoji: '🐴', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Dönüşüm güçle geliyor', meaningEn: 'Change comes with force'),
      CardSymbol(emoji: '🌅', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Her son yeni başlangıç', meaningEn: 'Every end a new start'),
      CardSymbol(emoji: '🏴', nameTr: 'Bayrak', nameEn: 'Banner', meaningTr: 'Eski düzen bitiyor', meaningEn: 'Old order is ending'),
      CardSymbol(emoji: '🤴', nameTr: 'Kral', nameEn: 'King', meaningTr: 'Herkes eşit dönüşümde', meaningEn: 'All equal in change'),
    ],
    14: [ // Temperance
      CardSymbol(emoji: '🏺', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Zıtlıkları birleştirmen', meaningEn: 'Uniting opposites'),
      CardSymbol(emoji: '🪶', nameTr: 'Kanatlar', nameEn: 'Wings', meaningTr: 'Ruh ve beden köprün', meaningEn: 'Body-spirit bridge'),
      CardSymbol(emoji: '🦶', nameTr: 'Ayak', nameEn: 'Foot', meaningTr: 'Bilinçaltı bağlantın', meaningEn: 'Subconscious link'),
    ],
    15: [ // The Devil
      CardSymbol(emoji: '⛓️', nameTr: 'Zincir', nameEn: 'Chain', meaningTr: 'İstersen çıkabilirsin', meaningEn: 'You can escape if willing'),
      CardSymbol(emoji: '🔥', nameTr: 'Ateş', nameEn: 'Flame', meaningTr: 'Bağımlılık sessiz yakar', meaningEn: 'Addiction burns silently'),
      CardSymbol(emoji: '👤', nameTr: 'Figürler', nameEn: 'Figures', meaningTr: 'Korkularla yüzleşme zamanı', meaningEn: 'Time to face your fears'),
    ],
    16: [ // The Tower
      CardSymbol(emoji: '⚡', nameTr: 'Yıldırım', nameEn: 'Lightning', meaningTr: 'Gerçek anında açığa çıkar', meaningEn: 'Truth revealed instantly'),
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Ego ile inşa yıkılır', meaningEn: 'Ego-built can collapse'),
      CardSymbol(emoji: '🔥', nameTr: 'Alev', nameEn: 'Flame', meaningTr: 'Kalan şey gerçektir', meaningEn: 'What remains is real'),
    ],
    17: [ // The Star
      CardSymbol(emoji: '🌟', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Karanlıktan sonra umut', meaningEn: 'Hope after darkness'),
      CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Toprağı ve ruhu besler', meaningEn: 'Feeds earth and spirit'),
      CardSymbol(emoji: '🐦', nameTr: 'Kuş', nameEn: 'Bird', meaningTr: 'Ruhun uçmaya hazır', meaningEn: 'Your soul is ready to fly'),
    ],
    18: [ // The Moon
      CardSymbol(emoji: '🌕', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Her gördüğün gerçek değil', meaningEn: 'Not all you see is real'),
      CardSymbol(emoji: '🏰', nameTr: 'Kuleler', nameEn: 'Towers', meaningTr: 'Bilinen-bilinmeyen kapı', meaningEn: 'Known-unknown gate'),
      CardSymbol(emoji: '🐺', nameTr: 'Kurt', nameEn: 'Wolf', meaningTr: 'Evcil ve vahşi benin', meaningEn: 'Your tame and wild self'),
      CardSymbol(emoji: '🦞', nameTr: 'Kerevit', nameEn: 'Crayfish', meaningTr: 'Derinlerden gelen korkular', meaningEn: 'Fears surfacing from the depths'),
    ],
    19: [ // The Sun
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'En aydınlık anın geldi', meaningEn: 'Your brightest moment has come'),
      CardSymbol(emoji: '👶', nameTr: 'Çocuk', nameEn: 'Child', meaningTr: 'İçindeki çocuk uyanıyor', meaningEn: 'Inner child awakens'),
      CardSymbol(emoji: '🌻', nameTr: 'Çiçek', nameEn: 'Flower', meaningTr: 'Işığa yönelişin', meaningEn: 'Your turn to light'),
      CardSymbol(emoji: '🐴', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Saf enerjiyle koşuyorsun', meaningEn: 'Galloping with pure energy'),
    ],
    20: [ // Judgement
      CardSymbol(emoji: '📯', nameTr: 'Boru', nameEn: 'Trumpet', meaningTr: 'Ruhun seni uyandırıyor', meaningEn: 'Your spirit wakes you'),
      CardSymbol(emoji: '👼', nameTr: 'Cebrail', nameEn: 'Gabriel', meaningTr: 'Eylemlerin tartılıyor', meaningEn: 'Your actions are weighed'),
      CardSymbol(emoji: '🧟', nameTr: 'Figürler', nameEn: 'Figures', meaningTr: 'Yeni sen doğuyor', meaningEn: 'New you is rising'),
    ],
    21: [ // The World
      CardSymbol(emoji: '💃', nameTr: 'Dansçı', nameEn: 'Dancer', meaningTr: 'Yolculuğun tamam, kutla!', meaningEn: 'Journey complete, celebrate!'),
      CardSymbol(emoji: '🌿', nameTr: 'Çelenk', nameEn: 'Wreath', meaningTr: 'Evrenin taktığı taç', meaningEn: 'Crown from the universe'),
      CardSymbol(emoji: '🦅', nameTr: 'Yaratıklar', nameEn: 'Creatures', meaningTr: 'Dört element dengede', meaningEn: 'Four elements in balance'),
    ],
  };
  ...
  const minorSpecificSymbols = <int, List<CardSymbol>>{
    22: [ // Ace of Cups
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'Taşan duygusal bereketin', meaningEn: 'Your overflowing emotional abundance'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Kalbini aydınlatan ışık', meaningEn: 'The light illuminating your heart'),
      CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Duygularının serbest akışı', meaningEn: 'Free flow of your emotions'),
      CardSymbol(emoji: '🐟', nameTr: 'Balık', nameEn: 'Fish', meaningTr: 'Bilinçaltından gelen mesajlar', meaningEn: 'Messages from your subconscious'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Ruhani rehberliğin', meaningEn: 'Your spiritual guidance'),
    ],
    23: [ // Two of Cups
      CardSymbol(emoji: '👩', nameTr: 'Kadın', nameEn: 'Woman', meaningTr: 'Seni tamamlayan enerji', meaningEn: 'The energy that completes you'),
      CardSymbol(emoji: '👨', nameTr: 'Erkek', nameEn: 'Man', meaningTr: 'Karşındaki aynan', meaningEn: 'Your mirror reflection'),
      CardSymbol(emoji: '🥂', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Karşılıklı duygu paylaşımı', meaningEn: 'Mutual emotional exchange'),
      CardSymbol(emoji: '🥂', nameTr: 'Kadeh', nameEn: 'Chalice', meaningTr: 'Sana dönen sevgi', meaningEn: 'Love returning to you'),
      CardSymbol(emoji: '⚕️', nameTr: 'Caduceus', nameEn: 'Caduceus', meaningTr: 'Ruhsal bağınızın gücü', meaningEn: 'Power of your spiritual bond'),
      CardSymbol(emoji: '💫', nameTr: 'Enerji', nameEn: 'Energy', meaningTr: 'Aranızdaki çekim gücü', meaningEn: 'The attraction between you'),
    ],
    24: [ // Three of Cups
      CardSymbol(emoji: '💃', nameTr: 'Dost', nameEn: 'Friend', meaningTr: 'Seni destekleyen bağlar', meaningEn: 'Bonds that support you'),
      CardSymbol(emoji: '💃', nameTr: 'Kutlama', nameEn: 'Celebration', meaningTr: 'Paylaşılan sevinç', meaningEn: 'Shared joy'),
      CardSymbol(emoji: '💃', nameTr: 'Birlik', nameEn: 'Unity', meaningTr: 'Birlikte daha güçsünüz', meaningEn: 'Stronger together'),
      CardSymbol(emoji: '🥂', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Kutlanacak başarıların', meaningEn: 'Your achievements to celebrate'),
      CardSymbol(emoji: '🍇', nameTr: 'Meyve', nameEn: 'Fruit', meaningTr: 'Emeğinin hasadı geldi', meaningEn: 'Harvest of your efforts arrived'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Evren seninle kutluyor', meaningEn: 'The universe celebrates with you'),
    ],
    25: [ // Four of Cups
      CardSymbol(emoji: '🧘', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Kaçırdığın fırsatlar var', meaningEn: 'Opportunities you are missing'),
      CardSymbol(emoji: '🌳', nameTr: 'Ağaç', nameEn: 'Tree', meaningTr: 'Seni koruyan konfor alanın', meaningEn: 'Your protective comfort zone'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'Görmediğin yeni bir şans', meaningEn: 'A new chance you do not see'),
      CardSymbol(emoji: '✨', nameTr: 'Ruh Eli', nameEn: 'Spirit Hand', meaningTr: 'Evrenin sana uzattığı el', meaningEn: 'The hand the universe extends to you'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Değerini bilmediğin nimetler', meaningEn: 'Blessings you undervalue'),
    ],
    26: [ // Five of Cups
      CardSymbol(emoji: '👤', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Kaybettiklerine takılma', meaningEn: 'Do not dwell on your losses'),
      CardSymbol(emoji: '🍷', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Yaşanan hayal kırıklığı', meaningEn: 'The disappointment you experienced'),
      CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Akanı geri getiremezsin', meaningEn: 'You cannot bring back what flowed away'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Hâlâ sahip olduğun değerler', meaningEn: 'Values you still possess'),
      CardSymbol(emoji: '🌉', nameTr: 'Köprü', nameEn: 'Bridge', meaningTr: 'Yeni başlangıca geçiş yolun', meaningEn: 'Your path to a new beginning'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Umut hep arkanda duruyor', meaningEn: 'Hope always stands behind you'),
    ],
    27: [ // Six of Cups
      CardSymbol(emoji: '👦', nameTr: 'Çocuk', nameEn: 'Child', meaningTr: 'Masumiyetine dönüş zamanı', meaningEn: 'Time to return to your innocence'),
      CardSymbol(emoji: '👧', nameTr: 'Çocuk', nameEn: 'Child', meaningTr: 'Geçmişten gelen sıcaklık', meaningEn: 'Warmth coming from the past'),
      CardSymbol(emoji: '🌸', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Nostalji ve tatlı anıların', meaningEn: 'Your nostalgia and sweet memories'),
      CardSymbol(emoji: '🌕', nameTr: 'Dolunay', nameEn: 'Full Moon', meaningTr: 'Duygusal tamlık hissin', meaningEn: 'Your sense of emotional wholeness'),
      CardSymbol(emoji: '🏘️', nameTr: 'Köy', nameEn: 'Village', meaningTr: 'Köklerine duyduğun özlem', meaningEn: 'Your longing for your roots'),
      CardSymbol(emoji: '🛣️', nameTr: 'Patika', nameEn: 'Path', meaningTr: 'Geçmişe açılan yolun', meaningEn: 'Your path opening to the past'),
    ],
    28: [ // Seven of Cups
      CardSymbol(emoji: '👤', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Hayallerinin esiri olma', meaningEn: 'Do not be a prisoner of dreams'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Seçenekler karmaşası', meaningEn: 'Confusion of choices'),
      CardSymbol(emoji: '🐉', nameTr: 'Ejderha', nameEn: 'Dragon', meaningTr: 'Korku dolu bir hayalin', meaningEn: 'A dream filled with fear'),
      CardSymbol(emoji: '🐍', nameTr: 'Yılan', nameEn: 'Snake', meaningTr: 'Aldatıcı bir arzu', meaningEn: 'A deceptive desire'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Ulaşılmaz bir hedef', meaningEn: 'An unreachable goal'),
      CardSymbol(emoji: '💎', nameTr: 'Mücevher', nameEn: 'Jewel', meaningTr: 'Sahte parıltıya kapılma', meaningEn: 'Do not fall for false glitter'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Gerçek hedefin hangisi?', meaningEn: 'Which is your real goal?'),
    ],
    29: [ // Eight of Cups
      CardSymbol(emoji: '🚶', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Geride bırakma cesaretinIN sesi', meaningEn: 'The voice of your courage to let go'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Artık seni doyurmayan şeyler', meaningEn: 'Things that no longer fulfill you'),
      CardSymbol(emoji: '🌒', nameTr: 'Tutulma', nameEn: 'Eclipse', meaningTr: 'Bilinçaltından gelen işaret', meaningEn: 'A signal from your subconscious'),
      CardSymbol(emoji: '🏔️', nameTr: 'Dağ', nameEn: 'Mountain', meaningTr: 'Önünde yeni keşifler var', meaningEn: 'New discoveries lie ahead'),
      CardSymbol(emoji: '🌉', nameTr: 'Köprü', nameEn: 'Bridge', meaningTr: 'Eskiyle yeninin arasındasın', meaningEn: 'You are between old and new'),
      CardSymbol(emoji: '🛤️', nameTr: 'Patika', nameEn: 'Path', meaningTr: 'Ruhunun seni çektiği yön', meaningEn: 'The direction your soul pulls you'),
    ],
    30: [ // Nine of Cups
      CardSymbol(emoji: '🧘', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Dileklerin gerçekleşiyor', meaningEn: 'Your wishes are coming true'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Duygusal tatmin ve bolluk', meaningEn: 'Emotional satisfaction and abundance'),
      CardSymbol(emoji: '🎭', nameTr: 'Perde', nameEn: 'Curtain', meaningTr: 'Daha fazlası perdenin ardında', meaningEn: 'More awaits behind the curtain'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Evren sana gülümsüyor', meaningEn: 'The universe smiles upon you'),
    ],
    31: [ // Ten of Cups
      CardSymbol(emoji: '👫', nameTr: 'Aile', nameEn: 'Family', meaningTr: 'Senin en derin arzun', meaningEn: 'Your deepest desire'),
      CardSymbol(emoji: '🧒', nameTr: 'Çocuklar', nameEn: 'Children', meaningTr: 'Paylaşılan mutluluk', meaningEn: 'Shared happiness'),
      CardSymbol(emoji: '🌈', nameTr: 'Kupalar', nameEn: 'Cups', meaningTr: 'Duygusal zenginliğin zirvesi', meaningEn: 'Peak of your emotional richness'),
      CardSymbol(emoji: '🌈', nameTr: 'Gökkuşağı', nameEn: 'Rainbow', meaningTr: 'Evrenin sana vaadi', meaningEn: 'The universes promise to you'),
      CardSymbol(emoji: '🏡', nameTr: 'Ev', nameEn: 'Home', meaningTr: 'Güvenli limanın seni bekliyor', meaningEn: 'Your safe harbor awaits you'),
      CardSymbol(emoji: '🍇', nameTr: 'Meyve', nameEn: 'Fruit', meaningTr: 'Emeğinin meyvesi olgunlaştı', meaningEn: 'The fruit of your labor ripened'),
    ],
    32: [ // Page of Cups
      CardSymbol(emoji: '👦', nameTr: 'Genç', nameEn: 'Youth', meaningTr: 'Yeni duygusal keşiflerin', meaningEn: 'Your new emotional discoveries'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'Sana sunulan sürpriz', meaningEn: 'A surprise offered to you'),
      CardSymbol(emoji: '🐟', nameTr: 'Balık', nameEn: 'Fish', meaningTr: 'Beklenmedik bir mesaj geliyor', meaningEn: 'An unexpected message is coming'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Yaratıcılığının uyanışı', meaningEn: 'Awakening of your creativity'),
      CardSymbol(emoji: '🌊', nameTr: 'Dalga', nameEn: 'Wave', meaningTr: 'Duygusal heyecanlar kapıda', meaningEn: 'Emotional excitement at your door'),
    ],
    33: [ // Knight of Cups
      CardSymbol(emoji: '🏇', nameTr: 'Şövalye', nameEn: 'Knight', meaningTr: 'Romantik bir haberci geliyor', meaningEn: 'A romantic messenger is coming'),
      CardSymbol(emoji: '🐎', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Saf niyetle gelen bir teklif', meaningEn: 'An offer coming with pure intent'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'Sana uzatılan duygusal davet', meaningEn: 'An emotional invitation extended to you'),
      CardSymbol(emoji: '🧥', nameTr: 'Pelerin', nameEn: 'Cloak', meaningTr: 'Zarif ve sakin bir yaklaşım', meaningEn: 'An elegant and calm approach'),
      CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Duyguların seni yönlendiriyor', meaningEn: 'Your emotions are guiding you'),
    ],
    34: [ // Queen of Cups
      CardSymbol(emoji: '👸', nameTr: 'Kraliçe', nameEn: 'Queen', meaningTr: 'Sezgisel bilgeliğin', meaningEn: 'Your intuitive wisdom'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'İçsel zenginliğin', meaningEn: 'Your inner richness'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Duygularına hakimsin', meaningEn: 'You rule your emotions'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Aydınlanmış sevgi enerjin', meaningEn: 'Your enlightened love'),
      CardSymbol(emoji: '🌊', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Empati gücün yüksek', meaningEn: 'Strong empathy power'),
    ],
    35: [ // King of Cups
      CardSymbol(emoji: '🤴', nameTr: 'Kral', nameEn: 'King', meaningTr: 'Duygusal olgunluğun', meaningEn: 'Your emotional maturity'),
      CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'İçsel zenginliğin', meaningEn: 'Your inner richness'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Kaosta bile dengedesin', meaningEn: 'Balanced even in chaos'),
      CardSymbol(emoji: '🌊', nameTr: 'Deniz', nameEn: 'Sea', meaningTr: 'Derin duyguların gücü', meaningEn: 'Power of deep emotions'),
    ],
    36: [ // Ace of Wands
      CardSymbol(emoji: '✨', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Evrenin sana verdiği güç', meaningEn: 'The power the universe gives you'),
      CardSymbol(emoji: '🌱', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Yeni tutkulu başlangıcın', meaningEn: 'Your new passionate beginning'),
      CardSymbol(emoji: '🍃', nameTr: 'Yaprak', nameEn: 'Leaf', meaningTr: 'Büyüme potansiyelin', meaningEn: 'Your growth potential'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Hedefinin görüntüsü', meaningEn: 'The vision of your goal'),
      CardSymbol(emoji: '☁️', nameTr: 'Bulut', nameEn: 'Cloud', meaningTr: 'Hayallerin netleşiyor', meaningEn: 'Your dreams are becoming clear'),
    ],
    37: [ // Two of Wands
      CardSymbol(emoji: '👤', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Büyük kararın eşiğindesin', meaningEn: 'You are on the edge of a big decision'),
      CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Elindeki güç ve planlama', meaningEn: 'Power and planning in your hands'),
      CardSymbol(emoji: '🔮', nameTr: 'Küre', nameEn: 'Globe', meaningTr: 'Geleceğe bakışın', meaningEn: 'Your vision of the future'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Konfor alanından çıkma zamanı', meaningEn: 'Time to leave your comfort zone'),
      CardSymbol(emoji: '🌊', nameTr: 'Ufuk', nameEn: 'Horizon', meaningTr: 'Seni bekleyen olanaklar', meaningEn: 'Possibilities awaiting you'),
    ],
    38: [ // Three of Wands
      CardSymbol(emoji: '👤', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Planların hayat buluyor', meaningEn: 'Your plans are coming to life'),
      CardSymbol(emoji: '🪵', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Attığın sağlam temeller', meaningEn: 'The solid foundations you laid'),
      CardSymbol(emoji: '⛵', nameTr: 'Gemi', nameEn: 'Ship', meaningTr: 'Yola çıkan umutların', meaningEn: 'Your hopes setting sail'),
      CardSymbol(emoji: '🌅', nameTr: 'Ufuk', nameEn: 'Horizon', meaningTr: 'Genişleyen vizyonun', meaningEn: 'Your expanding vision'),
    ],
    39: [ // Four of Wands
      CardSymbol(emoji: '🪵', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Sağlam temeller üzerine kurulu', meaningEn: 'Built on solid foundations'),
      CardSymbol(emoji: '🌸', nameTr: 'Çelenk', nameEn: 'Garland', meaningTr: 'Kutlamaya değer başarın', meaningEn: 'An achievement worth celebrating'),
      CardSymbol(emoji: '💃', nameTr: 'Çift', nameEn: 'Couple', meaningTr: 'Paylaşılan mutluluk anı', meaningEn: 'A shared moment of happiness'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Güvenli yuvanın simgesi', meaningEn: 'Symbol of your safe haven'),
      CardSymbol(emoji: '🌅', nameTr: 'Ufuk', nameEn: 'Horizon', meaningTr: 'Altın çağın başlıyor', meaningEn: 'Your golden age is beginning'),
    ],
    40: [ // Five of Wands
      CardSymbol(emoji: '🤼', nameTr: 'Figürler', nameEn: 'Figures', meaningTr: 'Etrafındaki rekabet ortamı', meaningEn: 'The competitive environment around you'),
      CardSymbol(emoji: '⚔️', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Çatışan fikirler ve görüşler', meaningEn: 'Clashing ideas and opinions'),
      CardSymbol(emoji: '✨', nameTr: 'Kıvılcım', nameEn: 'Spark', meaningTr: 'Sürtüşmeden doğan enerji', meaningEn: 'Energy born from friction'),
    ],
    41: [ // Six of Wands
      CardSymbol(emoji: '🏇', nameTr: 'Binici', nameEn: 'Rider', meaningTr: 'Senin zafer anın geldi', meaningEn: 'Your moment of victory has come'),
      CardSymbol(emoji: '🐎', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Başarıya taşıyan gücün', meaningEn: 'The force carrying you to success'),
      CardSymbol(emoji: '🌿', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Kazandığın saygı ve itibar', meaningEn: 'The respect and prestige you earned'),
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Hak ettiğin tanınma', meaningEn: 'The recognition you deserve'),
      CardSymbol(emoji: '👥', nameTr: 'Kalabalık', nameEn: 'Crowd', meaningTr: 'Seni alkışlayanlar var', meaningEn: 'There are those who applaud you'),
    ],
    42: [ // Seven of Wands
      CardSymbol(emoji: '🛡️', nameTr: 'Savunucu', nameEn: 'Defender', meaningTr: 'Tek başına durma cesaretin', meaningEn: 'Your courage to stand alone'),
      CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Elindeki en güçlü silahın', meaningEn: 'Your most powerful weapon'),
      CardSymbol(emoji: '⚔️', nameTr: 'Saldırı', nameEn: 'Attack', meaningTr: 'Sana yönelen dış baskılar', meaningEn: 'External pressures aimed at you'),
      CardSymbol(emoji: '🔥', nameTr: 'Ateş', nameEn: 'Fire', meaningTr: 'Seni ayakta tutan irade gücün', meaningEn: 'The willpower keeping you standing'),
    ],
    43: [ // Eight of Wands
      CardSymbol(emoji: '☄️', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Hızla gelen haberler', meaningEn: 'News arriving fast'),
      CardSymbol(emoji: '⛰️', nameTr: 'Tepeler', nameEn: 'Hills', meaningTr: 'Engeller geride kalıyor', meaningEn: 'Obstacles are falling behind'),
      CardSymbol(emoji: '🌊', nameTr: 'Nehir', nameEn: 'River', meaningTr: 'Hayatının akış hızı artıyor', meaningEn: 'The pace of your life is accelerating'),
    ],
    44: [ // Nine of Wands
      CardSymbol(emoji: '🤕', nameTr: 'Savaşçı', nameEn: 'Warrior', meaningTr: 'Yorgun ama pes etmeyen sen', meaningEn: 'Tired but you never give up'),
      CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Son savunma hattın bu', meaningEn: 'This is your last line of defense'),
      CardSymbol(emoji: '🪵', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Geçirdiğin tüm sınavlar', meaningEn: 'All the trials you have endured'),
      CardSymbol(emoji: '🔥', nameTr: 'Alev', nameEn: 'Flame', meaningTr: 'İçindeki sönmeyen ateş', meaningEn: 'The unquenchable fire within you'),
    ],
    45: [ // Ten of Wands
      CardSymbol(emoji: '🚶', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Omuzlarındaki ağır yük', meaningEn: 'The heavy burden on your shoulders'),
      CardSymbol(emoji: '🪵', nameTr: 'Asalar', nameEn: 'Wands', meaningTr: 'Fazla sorumluluk üstlendin', meaningEn: 'You took on too much responsibility'),
      CardSymbol(emoji: '🏘️', nameTr: 'Kasaba', nameEn: 'Town', meaningTr: 'Hedefin çok yakında artık', meaningEn: 'Your goal is very close now'),
      CardSymbol(emoji: '🛣️', nameTr: 'Patika', nameEn: 'Path', meaningTr: 'Son birkaç adım kaldı', meaningEn: 'Just a few steps left'),
    ],
    46: [ // Page of Wands
      CardSymbol(emoji: '👦', nameTr: 'Genç', nameEn: 'Youth', meaningTr: 'Yeni maceranın başlangıcı', meaningEn: 'The beginning of a new adventure'),
      CardSymbol(emoji: '🌱', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'İçindeki yaratıcı kıvılcım', meaningEn: 'The creative spark within you'),
      CardSymbol(emoji: '🦎', nameTr: 'Semender', nameEn: 'Salamander', meaningTr: 'Ateşle dönüşüm gücün', meaningEn: 'Your power of transformation through fire'),
      CardSymbol(emoji: '🏔️', nameTr: 'Piramit', nameEn: 'Pyramid', meaningTr: 'Keşfedilecek gizemler', meaningEn: 'Mysteries to be explored'),
    ],
    47: [ // Knight of Wands
      CardSymbol(emoji: '🏇', nameTr: 'Şövalye', nameEn: 'Knight', meaningTr: 'Tutkuyla ileri atılışın', meaningEn: 'Your passionate charge forward'),
      CardSymbol(emoji: '🐎', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Dizginlenemez enerjin', meaningEn: 'Your untamable energy'),
      CardSymbol(emoji: '🔥', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Yanan tutku ve kararlılığın', meaningEn: 'Your burning passion and determination'),
      CardSymbol(emoji: '🧥', nameTr: 'Pelerin', nameEn: 'Cloak', meaningTr: 'Cesurca aldığın riskler', meaningEn: 'The risks you bravely take'),
      CardSymbol(emoji: '🏔️', nameTr: 'Piramit', nameEn: 'Pyramid', meaningTr: 'Uzaktaki hedeflerin', meaningEn: 'Your distant goals'),
    ],
    48: [ // Queen of Wands
      CardSymbol(emoji: '👸', nameTr: 'Kraliçe', nameEn: 'Queen', meaningTr: 'İçindeki lider enerjisi', meaningEn: 'The leader energy within you'),
      CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Yaratıcı gücünün simgesi', meaningEn: 'Symbol of your creative power'),
      CardSymbol(emoji: '🌻', nameTr: 'Ayçiçeği', nameEn: 'Sunflower', meaningTr: 'Neşen ve pozitif enerjin', meaningEn: 'Your joy and positive energy'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Cesaretle oturduğun yer', meaningEn: 'The place you sit with courage'),
      CardSymbol(emoji: '🐈‍⬛', nameTr: 'Kedi', nameEn: 'Cat', meaningTr: 'Sezgisel güçlerin uyanıyor', meaningEn: 'Your intuitive powers are awakening'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Etrafına yaydığın ışık', meaningEn: 'The light you radiate around you'),
    ],
    49: [ // King of Wands
      CardSymbol(emoji: '🤴', nameTr: 'Kral', nameEn: 'King', meaningTr: 'Vizyoner liderliğin parıldıyor', meaningEn: 'Your visionary leadership shines'),
      CardSymbol(emoji: '🌱', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Büyüyen gücünün sembolü', meaningEn: 'Symbol of your growing power'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Doğal otoriten hissediliyor', meaningEn: 'Your natural authority is felt'),
      CardSymbol(emoji: '🦎', nameTr: 'Semender', nameEn: 'Salamander', meaningTr: 'Ateşten geçip güçlendin', meaningEn: 'You grew stronger through fire'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'İçindeki parlak ışık', meaningEn: 'The bright light within you'),
    ],
    50: [ // Ace of Swords
      CardSymbol(emoji: '✨', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Evrenin sana sunduğu netlik', meaningEn: 'The clarity the universe offers you'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Keskin zekânın gücü', meaningEn: 'The power of your sharp mind'),
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Zihinsel zafer yaklaşıyor', meaningEn: 'Mental victory is approaching'),
      CardSymbol(emoji: '🌿', nameTr: 'Defne', nameEn: 'Laurel', meaningTr: 'Barışla gelen başarın', meaningEn: 'Your success coming with peace'),
      CardSymbol(emoji: '☁️', nameTr: 'Bulut', nameEn: 'Cloud', meaningTr: 'Dağılan zihinsel sisin', meaningEn: 'Your mental fog is clearing'),
    ],
    51: [ // Two of Swords
      CardSymbol(emoji: '🙈', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Görmezden geldiğin gerçek', meaningEn: 'The truth you are ignoring'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'İçindeki ikilem', meaningEn: 'The dilemma within you'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Sezgine güvenme zamanı', meaningEn: 'Time to trust your intuition'),
      CardSymbol(emoji: '🌊', nameTr: 'Deniz', nameEn: 'Sea', meaningTr: 'Bastırdığın duygular', meaningEn: 'Emotions you have suppressed'),
    ],
    52: [ // Three of Swords
      CardSymbol(emoji: '❤️', nameTr: 'Kalp', nameEn: 'Heart', meaningTr: 'Acı veren bir gerçek', meaningEn: 'A painful truth'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Seni yaralayan sözler', meaningEn: 'Words that wounded you'),
      CardSymbol(emoji: '🌧️', nameTr: 'Yağmur', nameEn: 'Rain', meaningTr: 'Dökülmesi gereken gözyaşları', meaningEn: 'Tears that need to be shed'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Geceyi aydınlatan acı bilgelik', meaningEn: 'Painful wisdom illuminating the night'),
      CardSymbol(emoji: '⛈️', nameTr: 'Fırtına', nameEn: 'Storm', meaningTr: 'Geçici bir dönem bu sadece', meaningEn: 'This is only a temporary phase'),
    ],
    53: [ // Four of Swords
      CardSymbol(emoji: '🛌', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Ruhunun dinlenme ihtiyacı', meaningEn: 'Your souls need for rest'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Askıya aldığın mücadeleler', meaningEn: 'Battles you have put on hold'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Hazır olduğunda döneceksin', meaningEn: 'You will return when ready'),
      CardSymbol(emoji: '🪟', nameTr: 'Vitray', nameEn: 'Stained Glass', meaningTr: 'İç huzurunun kaynağı', meaningEn: 'The source of your inner peace'),
    ],
    54: [ // Five of Swords
      CardSymbol(emoji: '🏆', nameTr: 'Galip', nameEn: 'Victor', meaningTr: 'Kazandın ama neyi kaybettin?', meaningEn: 'You won but what did you lose?'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Ele geçirdiğin avantaj', meaningEn: 'The advantage you seized'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Bıraktığın yaralar var', meaningEn: 'There are wounds you left behind'),
      CardSymbol(emoji: '🚶', nameTr: 'Figürler', nameEn: 'Figures', meaningTr: 'Uzaklaşan ilişkilerin', meaningEn: 'Your distancing relationships'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Vicdanının sesi yükseliyor', meaningEn: 'The voice of your conscience rises'),
    ],
    55: [ // Six of Swords
      CardSymbol(emoji: '🛶', nameTr: 'Kayıkçı', nameEn: 'Boatman', meaningTr: 'Seni güvenli kıyıya taşıyan', meaningEn: 'The one carrying you to safe shores'),
      CardSymbol(emoji: '👩‍👧', nameTr: 'Anne', nameEn: 'Mother', meaningTr: 'Korunan değerli varlıkların', meaningEn: 'Your precious ones being protected'),
      CardSymbol(emoji: '🚤', nameTr: 'Tekne', nameEn: 'Boat', meaningTr: 'Geçiş döneminin aracı', meaningEn: 'The vehicle of your transition'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Yanında taşıdığın dersler', meaningEn: 'Lessons you carry with you'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Belirsizlikte rehberin var', meaningEn: 'You have a guide in uncertainty'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Daha iyi günler yaklaşıyor', meaningEn: 'Better days are approaching'),
    ],
    56: [ // Seven of Swords
      CardSymbol(emoji: '🥷', nameTr: 'Hırsız', nameEn: 'Thief', meaningTr: 'Gizlice yapılan hamleler', meaningEn: 'Moves made in secret'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Strateji ve kurnazlık', meaningEn: 'Strategy and cunning'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Geride bıraktıkların', meaningEn: 'What you left behind'),
      CardSymbol(emoji: '⛺', nameTr: 'Çadır', nameEn: 'Tent', meaningTr: 'Fark edilmeden kaçış', meaningEn: 'Escaping without being noticed'),
      CardSymbol(emoji: '🔥', nameTr: 'Ateş', nameEn: 'Fire', meaningTr: 'Tehlikenin yakınlığı', meaningEn: 'The nearness of danger'),
      CardSymbol(emoji: '🌕', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Her şey ortaya çıkacak', meaningEn: 'Everything will come to light'),
    ],
    57: [ // Eight of Swords
      CardSymbol(emoji: '⛓️', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Kendi kendini sınırlaman', meaningEn: 'Your self-imposed limitations'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Zihinsel hapishanende', meaningEn: 'In your mental prison'),
      CardSymbol(emoji: '🌙', nameTr: 'Ay', nameEn: 'Moon', meaningTr: 'Gerçeği görmüyorsun', meaningEn: 'You are not seeing the truth'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Çıkış yolu aslında var', meaningEn: 'The way out actually exists'),
    ],
    58: [ // Nine of Swords
      CardSymbol(emoji: '😱', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Seni uykusuz bırakan kaygılar', meaningEn: 'Anxieties keeping you sleepless'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Zihindeki kâbus döngüsü', meaningEn: 'The nightmare cycle in your mind'),
      CardSymbol(emoji: '🛏️', nameTr: 'Yatak', nameEn: 'Bed', meaningTr: 'Huzursuz ruhunun yansıması', meaningEn: 'Reflection of your restless soul'),
      CardSymbol(emoji: '🪟', nameTr: 'Pencere', nameEn: 'Window', meaningTr: 'Şafak yaklaşıyor dayanman lazım', meaningEn: 'Dawn approaches you must endure'),
    ],
    59: [ // Ten of Swords
      CardSymbol(emoji: '🩸', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'En derin düşüş noktası', meaningEn: 'Your deepest point of fall'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıçlar', nameEn: 'Swords', meaningTr: 'Artık daha kötüsü yok', meaningEn: 'It cannot get worse than this'),
      CardSymbol(emoji: '🌅', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Yeniden doğuş başlıyor', meaningEn: 'Rebirth is beginning'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Geride bırakılan eski düzen', meaningEn: 'The old order left behind'),
    ],
    60: [ // Page of Swords
      CardSymbol(emoji: '👦', nameTr: 'Genç', nameEn: 'Youth', meaningTr: 'Meraklı ve keskin zekân', meaningEn: 'Your curious and sharp mind'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Yeni fikirlerinin gücü', meaningEn: 'The power of your new ideas'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Aydınlanan zihin', meaningEn: 'An illuminated mind'),
      CardSymbol(emoji: '🧥', nameTr: 'Pelerin', nameEn: 'Cloak', meaningTr: 'Hazırlıksız cesaretin', meaningEn: 'Your unprepared courage'),
      CardSymbol(emoji: '🐦', nameTr: 'Kuş', nameEn: 'Bird', meaningTr: 'Özgür düşüncelerin', meaningEn: 'Your free thoughts'),
    ],
    61: [ // Knight of Swords
      CardSymbol(emoji: '🏇', nameTr: 'Şövalye', nameEn: 'Knight', meaningTr: 'Hızlı ve keskin hamlelerin', meaningEn: 'Your fast and sharp moves'),
      CardSymbol(emoji: '🐎', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Durdurulamaz kararlılığın', meaningEn: 'Your unstoppable determination'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Zihinsel saldırı gücün', meaningEn: 'Your mental attack power'),
      CardSymbol(emoji: '⚡', nameTr: 'Şimşek', nameEn: 'Lightning', meaningTr: 'Ani değişim geliyor', meaningEn: 'Sudden change is coming'),
      CardSymbol(emoji: '🧥', nameTr: 'Pelerin', nameEn: 'Cloak', meaningTr: 'Geride bırakılan tereddüt', meaningEn: 'Hesitation left behind'),
    ],
    62: [ // Queen of Swords
      CardSymbol(emoji: '👸', nameTr: 'Kraliçe', nameEn: 'Queen', meaningTr: 'Duygusal netliğin gücü', meaningEn: 'Power of your emotional clarity'),
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Zihinsel olgunluğun', meaningEn: 'Your mental maturity'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Keskin sezgi ve mantığın', meaningEn: 'Your sharp intuition and logic'),
      CardSymbol(emoji: '👋', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Gerçeği kabul etme cesaretin', meaningEn: 'Your courage to accept truth'),
      CardSymbol(emoji: '🦋', nameTr: 'Kelebek', nameEn: 'Butterfly', meaningTr: 'Dönüşen düşüncelerin', meaningEn: 'Your transforming thoughts'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Bağımsız duruşun', meaningEn: 'Your independent stance'),
      CardSymbol(emoji: '⚡', nameTr: 'Şimşek', nameEn: 'Lightning', meaningTr: 'Geçmişten gelen dersler', meaningEn: 'Lessons from the past'),
    ],
    63: [ // King of Swords
      CardSymbol(emoji: '🤴', nameTr: 'Kral', nameEn: 'King', meaningTr: 'Adil ve objektif karar gücün', meaningEn: 'Your fair and objective decision power'),
      CardSymbol(emoji: '👑', nameTr: 'Taç', nameEn: 'Crown', meaningTr: 'Entelektüel otoriten', meaningEn: 'Your intellectual authority'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Mantığın keskin kenarı', meaningEn: 'The sharp edge of your logic'),
      CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Dengeleyici güç elinde', meaningEn: 'Balancing power in your hands'),
      CardSymbol(emoji: '🦅', nameTr: 'Kartal', nameEn: 'Eagle', meaningTr: 'Yüksekten gören vizyonun', meaningEn: 'Your vision that sees from above'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Tarafsız ve sağlam duruşun', meaningEn: 'Your impartial and firm stance'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Evrensel adalet enerjisi', meaningEn: 'Universal justice energy'),
    ],
    64: [ // Ace of Pentacles
      CardSymbol(emoji: '✨', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Evrenin sana sunduğu fırsat', meaningEn: 'The opportunity the universe offers you'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Maddi bereketin kapısı', meaningEn: 'The door to your material abundance'),
      CardSymbol(emoji: '🌿', nameTr: 'Kemer', nameEn: 'Arch', meaningTr: 'Bolluk bahçesinin girişi', meaningEn: 'The entrance to the garden of plenty'),
      CardSymbol(emoji: '🛣️', nameTr: 'Patika', nameEn: 'Path', meaningTr: 'Refahın doğru yolundasın', meaningEn: 'You are on the right path to prosperity'),
      CardSymbol(emoji: '🌳', nameTr: 'Bahçe', nameEn: 'Garden', meaningTr: 'Emeğinle büyüyecek toprak', meaningEn: 'Soil that will grow with your effort'),
    ],
    65: [ // Two of Pentacles
      CardSymbol(emoji: '🤹', nameTr: 'Jonglör', nameEn: 'Juggler', meaningTr: 'Denge sanatında ustalaşıyorsun', meaningEn: 'You are mastering the art of balance'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'İş hayatının dengesi', meaningEn: 'The balance of your work life'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Özel hayatının dengesi', meaningEn: 'The balance of your personal life'),
      CardSymbol(emoji: '♾️', nameTr: 'Bant', nameEn: 'Band', meaningTr: 'Akışta kalmayı öğreniyorsun', meaningEn: 'You are learning to stay in flow'),
      CardSymbol(emoji: '🌊', nameTr: 'Dalga', nameEn: 'Wave', meaningTr: 'İnişli çıkışlı dönemin', meaningEn: 'Your period of ups and downs'),
      CardSymbol(emoji: '⛵', nameTr: 'Gemi', nameEn: 'Ship', meaningTr: 'Dışarıdan gelen değişkenler', meaningEn: 'External variables affecting you'),
    ],
    66: [ // Three of Pentacles
      CardSymbol(emoji: '👨‍🎨', nameTr: 'Usta', nameEn: 'Master', meaningTr: 'Ustalığının onayı geliyor', meaningEn: 'Recognition of your mastery is coming'),
      CardSymbol(emoji: '📜', nameTr: 'Mimarlar', nameEn: 'Architects', meaningTr: 'Takım çalışmasının gücü', meaningEn: 'The power of teamwork'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'İlk somut başarıların', meaningEn: 'Your first concrete achievements'),
      CardSymbol(emoji: '🏛️', nameTr: 'Kemer', nameEn: 'Arch', meaningTr: 'Sağlam temellerin var', meaningEn: 'You have solid foundations'),
      CardSymbol(emoji: '🪟', nameTr: 'Pencere', nameEn: 'Window', meaningTr: 'Detaylara verdiğin özen', meaningEn: 'The care you give to details'),
    ],
    67: [ // Four of Pentacles
      CardSymbol(emoji: '😠', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Bırakamadığın kontrol', meaningEn: 'The control you cannot let go of'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Zihinsel takıntıların', meaningEn: 'Your mental obsessions'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Kalbini kapadığın şeyler', meaningEn: 'Things you closed your heart to'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Güvenlik ihtiyacın çok yüksek', meaningEn: 'Your need for security is very high'),
      CardSymbol(emoji: '🌞', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Kaçırdığın hayat var dışarıda', meaningEn: 'There is life you are missing outside'),
    ],
    68: [ // Five of Pentacles
      CardSymbol(emoji: '🤕', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Zor dönemin ağırlığı', meaningEn: 'The weight of your difficult period'),
      CardSymbol(emoji: '🥶', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Yardım istemeye cesaret et', meaningEn: 'Dare to ask for help'),
      CardSymbol(emoji: '🪟', nameTr: 'Vitray', nameEn: 'Stained Glass', meaningTr: 'Görmediğin destek çok yakın', meaningEn: 'Unseen support is very close'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Manevi zenginliğine dön', meaningEn: 'Return to your spiritual richness'),
      CardSymbol(emoji: '❄️', nameTr: 'Kar', nameEn: 'Snow', meaningTr: 'Geçici zorluk eriyecek', meaningEn: 'Temporary hardship will melt away'),
    ],
    69: [ // Six of Pentacles
      CardSymbol(emoji: '🤲', nameTr: 'Hayırsever', nameEn: 'Benefactor', meaningTr: 'Verme ve alma dengeniz', meaningEn: 'Your balance of giving and receiving'),
      CardSymbol(emoji: '⚖️', nameTr: 'Terazi', nameEn: 'Scales', meaningTr: 'Adil paylaşım enerjin', meaningEn: 'Your energy of fair sharing'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Sana gelen bolluk', meaningEn: 'Abundance coming to you'),
      CardSymbol(emoji: '🧍', nameTr: 'Çırak', nameEn: 'Student', meaningTr: 'İhtiyacı olan birine uzat', meaningEn: 'Extend your hand to someone in need'),
      CardSymbol(emoji: '🧍', nameTr: 'Çırak', nameEn: 'Student', meaningTr: 'Sana uzanan eller', meaningEn: 'Hands reaching out to you'),
    ],
    70: [ // Seven of Pentacles
      CardSymbol(emoji: '🧑‍🌾', nameTr: 'Çiftçi', nameEn: 'Farmer', meaningTr: 'Sabrının meyvesi yakında', meaningEn: 'The fruit of your patience is near'),
      CardSymbol(emoji: '🌳', nameTr: 'Çalı', nameEn: 'Bush', meaningTr: 'Büyüyen yatırımların', meaningEn: 'Your growing investments'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Emeğinin sonuçlarını görüyorsun', meaningEn: 'You see the results of your efforts'),
      CardSymbol(emoji: '🌞', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Doğru zamanlama çok önemli', meaningEn: 'Right timing is very important'),
    ],
    71: [ // Eight of Pentacles
      CardSymbol(emoji: '🔨', nameTr: 'Zanaatkar', nameEn: 'Craftsman', meaningTr: 'Ustalığa giden yoldasın', meaningEn: 'You are on the road to mastery'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Her detaya verdiğin emek', meaningEn: 'The effort you give to every detail'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Biriken deneyim ve beceri', meaningEn: 'Accumulating experience and skill'),
      CardSymbol(emoji: '🪚', nameTr: 'Tezgah', nameEn: 'Workbench', meaningTr: 'Özveriyle çalışmanın ödülü', meaningEn: 'The reward of dedicated work'),
    ],
    72: [ // Nine of Pentacles
      CardSymbol(emoji: '💃', nameTr: 'Kadın', nameEn: 'Woman', meaningTr: 'Kendi kendinle yetebilme gücün', meaningEn: 'Your power of self-sufficiency'),
      CardSymbol(emoji: '🦅', nameTr: 'Şahin', nameEn: 'Falcon', meaningTr: 'Eğitilmiş sezgilerin', meaningEn: 'Your trained intuitions'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Maddi bağımsızlığın', meaningEn: 'Your financial independence'),
      CardSymbol(emoji: '🍇', nameTr: 'Bağ', nameEn: 'Vineyard', meaningTr: 'Emeğinin hasadını topluyorsun', meaningEn: 'You are reaping the harvest of your labor'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Ruhani zenginliğin de var', meaningEn: 'You also have spiritual wealth'),
    ],
    73: [ // Ten of Pentacles
      CardSymbol(emoji: '👨‍👩‍👧‍👦', nameTr: 'Aile', nameEn: 'Family', meaningTr: 'Nesiller arası aktardığın miras', meaningEn: 'The legacy you pass across generations'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikkeler', nameEn: 'Coins', meaningTr: 'Kalıcı zenginlik kuruyorsun', meaningEn: 'You are building lasting wealth'),
      CardSymbol(emoji: '🏛️', nameTr: 'Kemer', nameEn: 'Arch', meaningTr: 'Köklü temellerin sağlam', meaningEn: 'Your deep foundations are solid'),
      CardSymbol(emoji: '🏰', nameTr: 'Konak', nameEn: 'Manor', meaningTr: 'Kurduğun güvenli düzen', meaningEn: 'The secure order you built'),
      CardSymbol(emoji: '🐕', nameTr: 'Köpek', nameEn: 'Dog', meaningTr: 'Sadakat ve aile bağların', meaningEn: 'Your loyalty and family bonds'),
    ],
    74: [ // Page of Pentacles
      CardSymbol(emoji: '👦', nameTr: 'Genç', nameEn: 'Youth', meaningTr: 'Yeni öğrenme yolculuğun', meaningEn: 'Your new learning journey'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Dikkatli ve planlı adımların', meaningEn: 'Your careful and planned steps'),
      CardSymbol(emoji: '🌾', nameTr: 'Tarla', nameEn: 'Field', meaningTr: 'Büyüme potansiyelin çok yüksek', meaningEn: 'Your growth potential is very high'),
      CardSymbol(emoji: '🛣️', nameTr: 'Patika', nameEn: 'Path', meaningTr: 'Adım adım hedefine yürüyorsun', meaningEn: 'You walk toward your goal step by step'),
      CardSymbol(emoji: '✨', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'İlhamının kaynağı burada', meaningEn: 'The source of your inspiration is here'),
    ],
    75: [ // Knight of Pentacles
      CardSymbol(emoji: '🏇', nameTr: 'Şövalye', nameEn: 'Knight', meaningTr: 'Sabırlı ve kararlı ilerleyişin', meaningEn: 'Your patient and determined progress'),
      CardSymbol(emoji: '🐎', nameTr: 'At', nameEn: 'Horse', meaningTr: 'Güvenilir ve istikrarlı güç', meaningEn: 'Reliable and stable power'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Maddi hedeflerine odağın', meaningEn: 'Your focus on material goals'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Kararlılığının meyvesi', meaningEn: 'The fruit of your determination'),
      CardSymbol(emoji: '🌾', nameTr: 'Tarla', nameEn: 'Field', meaningTr: 'Emek verdiğin toprak', meaningEn: 'The soil you nurture with effort'),
    ],
    76: [ // Queen of Pentacles
      CardSymbol(emoji: '👸', nameTr: 'Kraliçe', nameEn: 'Queen', meaningTr: 'Bolluk ve şefkat enerjin', meaningEn: 'Your energy of abundance and compassion'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Koruyucu bereketin taşıyor', meaningEn: 'Your protective blessings overflow'),
      CardSymbol(emoji: '🐇', nameTr: 'Tavşan', nameEn: 'Rabbit', meaningTr: 'Doğurganlık ve bereket', meaningEn: 'Fertility and abundance'),
      CardSymbol(emoji: '🧺', nameTr: 'Sepet', nameEn: 'Basket', meaningTr: 'Paylaştıkça çoğalan nimetler', meaningEn: 'Blessings that multiply as you share'),
      CardSymbol(emoji: '🌹', nameTr: 'Çardak', nameEn: 'Arbor', meaningTr: 'Güvenli ve güzel alanın', meaningEn: 'Your safe and beautiful space'),
      CardSymbol(emoji: '🏛️', nameTr: 'Sütun', nameEn: 'Pillar', meaningTr: 'Sağlam temellerin seni taşıyor', meaningEn: 'Your solid foundations carry you'),
    ],
    77: [ // King of Pentacles
      CardSymbol(emoji: '🤴', nameTr: 'Kral', nameEn: 'King', meaningTr: 'Maddi dünyanın efendisi sensin', meaningEn: 'You are the master of the material world'),
      CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Finansal gücün dorukta', meaningEn: 'Your financial power is at its peak'),
      CardSymbol(emoji: '🪄', nameTr: 'Asa', nameEn: 'Scepter', meaningTr: 'Kararlı liderliğin hissediliyor', meaningEn: 'Your determined leadership is felt'),
      CardSymbol(emoji: '🪑', nameTr: 'Taht', nameEn: 'Throne', meaningTr: 'Sarsılmaz otoriten', meaningEn: 'Your unshakable authority'),
      CardSymbol(emoji: '🍇', nameTr: 'Bağ', nameEn: 'Vineyard', meaningTr: 'Biriktirdiğin zenginlik', meaningEn: 'The wealth you have accumulated'),
      CardSymbol(emoji: '🏰', nameTr: 'Kale', nameEn: 'Castle', meaningTr: 'Kurduğun imparatorluk', meaningEn: 'The empire you built'),
      CardSymbol(emoji: '☀️', nameTr: 'Güneş', nameEn: 'Sun', meaningTr: 'Başarının tacı sende', meaningEn: 'The crown of success is yours'),
    ],
  };
  ...
  final suitSymbols = <List<CardSymbol>>[
    [ // Cups
      const CardSymbol(emoji: '🏆', nameTr: 'Kupa', nameEn: 'Cup', meaningTr: 'Kalbinin kapasitesi', meaningEn: 'Your hearts capacity'),
      const CardSymbol(emoji: '💧', nameTr: 'Su', nameEn: 'Water', meaningTr: 'Duyguların akışta', meaningEn: 'Emotions in flow'),
      const CardSymbol(emoji: '🌊', nameTr: 'Deniz', nameEn: 'Sea', meaningTr: 'Derinlerdeki dünyalar', meaningEn: 'Worlds in the depths'),
    ],
    [ // Wands
      const CardSymbol(emoji: '🪵', nameTr: 'Asa', nameEn: 'Wand', meaningTr: 'Yaratıcı ateşin', meaningEn: 'Your creative fire'),
      const CardSymbol(emoji: '🔥', nameTr: 'Ateş', nameEn: 'Fire', meaningTr: 'Sönmeyen alevin', meaningEn: 'Your eternal flame'),
      const CardSymbol(emoji: '🌱', nameTr: 'Filiz', nameEn: 'Sprout', meaningTr: 'Kök salan fikirlerin', meaningEn: 'Ideas taking root'),
    ],
    [ // Swords
      const CardSymbol(emoji: '⚔️', nameTr: 'Kılıç', nameEn: 'Sword', meaningTr: 'Düşüncenin gücü', meaningEn: 'Power of thought'),
      const CardSymbol(emoji: '☁️', nameTr: 'Bulut', nameEn: 'Cloud', meaningTr: 'Dağılan zihinsel sis', meaningEn: 'Clearing mental fog'),
      const CardSymbol(emoji: '💨', nameTr: 'Rüzgâr', nameEn: 'Wind', meaningTr: 'Eskiler savrulup gidiyor', meaningEn: 'Old swept away'),
    ],
    [ // Pentacles
      const CardSymbol(emoji: '🪙', nameTr: 'Sikke', nameEn: 'Coin', meaningTr: 'Somut sonuçların', meaningEn: 'Your tangible results'),
      const CardSymbol(emoji: '🌿', nameTr: 'Bahçe', nameEn: 'Garden', meaningTr: 'Ektiğin tohumlar', meaningEn: 'Seeds you planted'),
      const CardSymbol(emoji: '⭐', nameTr: 'Yıldız', nameEn: 'Star', meaningTr: 'Madde ve ruh köprüsü', meaningEn: 'Bridge of matter & spirit'),
    ],
  ];

  final rankSymbol = rank == 0
    ? const CardSymbol(emoji: '✨', nameTr: 'El', nameEn: 'Hand', meaningTr: 'Evren kapı açıyor', meaningEn: 'Universe opens a door')
    : rank >= 10
      ? const CardSymbol(emoji: '👤', nameTr: 'Figür', nameEn: 'Figure', meaningTr: 'Sen ya da çevrenden biri', meaningEn: 'You or someone near')
      : CardSymbol(emoji: rank.isEven ? '🔄' : '⚡', nameTr: rank.isEven ? 'Denge' : 'Aksiyon', nameEn: rank.isEven ? 'Balance' : 'Action', meaningTr: rank.isEven ? 'Durup değerlendirme zamanı' : 'Harekete geçme zamanı', meaningEn: rank.isEven ? 'Time to pause' : 'Time for action');
