...
const Map<int, CardMeaning> cardMeanings = {
  ...
  17: CardMeaning(
    ...
    movement: CardMovement.stillness,
    phase: CardPhase.neutral,
    pastTr: 'Gecenin karanlığı dinmiş. Çıplak kadın figürü bir testiyi sulara, diğerini toprağa dökerek seni yaralarından arındırmış.',
  ...
  20: CardMeaning(
    ...
    pastTr: 'Cebrail göklerden bulutlar arasında altın trompetini çalmış. Sen o sesi duymuş ve geçmişte kapalı kaldığın tabutundan kollarını açıp çıkmışsın.',
    ...
    directionTr: 'Trompetten sallanan o haçlı kırmızı bayrak senin nihai dirilişini müjdeliyor. Eskiden öldü sandığın umutlar mezarından fışkıracak.',
  ...
  21: CardMeaning(
    ...
    pastTr: 'Oval çelenk ve dört köşedeki aslan, boğa, kartal, melek ile dünya döngünü kapatmışsın. O sonsuz dansçı gibi yolculuğu şaheserle noktalamışsın.',
  ...
  23: CardMeaning(id: 23, themeTr: 'Karşılıklı bağ, ortaklık, derin çekim', themeEn: 'Mutual bond, partnership, deep attraction', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'İki kişi birbirinin gözüne bakarak kupalarını buluşturmuş. Caduceus asası ve kanatlı aslan başı bu bağı kutsal ilan etmiş. O karşılıklı söz hâlâ geçerliliğini koruyor.',
  ...
  40: CardMeaning(id: 40, themeTr: 'Rekabet, sürtüşme, yapıcı çatışma', themeEn: 'Competition, friction, constructive conflict', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Beş genç asalarını birbirine vurarak mücadele etmiş. Düzensiz ve kaotik görünse de bu sürtüşme aslında seni bilemiş ve güçlendirmiş.',
  ...
  48: CardMeaning(id: 48, themeTr: 'Güvenli liderlik, sıcak enerji, manyetik çekim', themeEn: 'Confident leadership, warm energy, magnetic pull', tone: CardTone.soft, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Aslan süslemeli tahtında oturan kraliçe, bir elinde asası diğerinde ayçiçeği, etrafına pozitif enerji yaymış. Siyah kedisi ayaklarının dibinde dururken herkes onun ışığına koşmuş.',
  ...
  57: CardMeaning(id: 57, themeTr: 'Zihinsel hapishane, kendi kendini sınırlama', themeEn: 'Mental prison, self-limitation, restriction', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Bağlanmış ve gözleri örtülü kadın, sekiz kılıcın arasında bataklıkta mahsur kalmış. Ama bağlar gevşekmiş — sen kendi korkularınla kendini hapsetmişsin.',
