...
List<CardSymbol> getCardSymbols(int cardId) {
  ...
  const minorSpecificSymbols = <int, List<CardSymbol>>{
    ...
    66: [ // Three of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['İlk somut başarıların'], meaningsEn: ['Your first concrete achievements']),
    ...
    67: [ // Four of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Ayaktaki Tılsımler', nameEn: 'Coins at Feet', meaningsTr: ['Güvenlik ihtiyacın çok yüksek'], meaningsEn: ['Your need for security is very high']),
    ...
    68: [ // Five of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['Manevi zenginliğine dön'], meaningsEn: ['Return to your spiritual richness']),
    ...
    69: [ // Six of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['Sana gelen bolluk'], meaningsEn: ['Abundance coming to you']),
    ...
    70: [ // Seven of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['Emeğinin görünen sonuçları'], meaningsEn: ['You see the results of your efforts']),
    ...
    71: [ // Eight of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tamamlanan Tılsımler', nameEn: 'Completed Coins', meaningsTr: ['Biriken deneyim ve beceri'], meaningsEn: ['Accumulating experience and skill']),
    ...
    72: [ // Nine of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['Maddi bağımsızlığın'], meaningsEn: ['Your financial independence']),
    ...
    73: [ // Ten of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımler', nameEn: 'Coins', meaningsTr: ['Kurulan kalıcı zenginlik'], meaningsEn: ['You are building lasting wealth']),
...
const Map<int, CardMeaning> cardMeanings = {
  ...
  64: CardMeaning(id: 64, themeTr: 'Maddi fırsat, yeni başlangıç, bereket kapısı', themeEn: 'Material opportunity, new start, abundance gate', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    ...
    directionTr: 'Tılsımyi cebine koyma, toprağa ek. Fırsatı değerlendir ve o bahçeyi büyüt. Bereket kapısı açık ama sonsuza dek açık kalmayacak.',
  ...
  70: CardMeaning(id: 70, themeTr: 'Sabır, yatırım, bekleme bilgeliği', themeEn: 'Patience, investment, wisdom of waiting', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Çapa dayanmış çiftçi, asmanın üzerindeki yedi tılsımye bakmış ve hasadın zamanını beklemiş. Sen de bir zamanlar o sabırlı çiftçi gibi emeğinin meyvesini beklemişsin.',
  ...
  71: CardMeaning(id: 71, themeTr: 'Özveri, ustalık yolu, detay odaklılık', themeEn: 'Dedication, path to mastery, attention to detail', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    ...
    directionTr: 'Her detaya aynı özeni ver. Zanaatçının sekiz tılsımsi gibi, tekrar tekrar yap ama her seferinde daha iyi yap. Ustalık bir an değil, bir süreçtir.',
  ...
  74: CardMeaning(id: 74, themeTr: 'Yeni öğrenme, pratik hayal, dikkatli adım', themeEn: 'New learning, practical dream, careful step', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Yeşil otların üzerinde yürüyen genç, elindeki tılsımye hayalci bir gözle bakmış. Uzaktaki dağlar hedefini, ayaklarının altındaki toprak ise sabırlı adımlarının simgesiymiş.',
    ...
    presentTr: 'Tılsımyi ellerinde tutuyorsun ve geleceği hayal ediyorsun. Ama bu boş bir rüya değil — ayakların yerde, gözlerin ufukta. Pratik bir hayalperestsin ve bu mükemmel bir denge.',
    ...
    directionTr: 'Hayalini tılsımye çevir. Adım adım, sabırla ve dikkatle ilerle. Genç öğrencinin merakıyla her fırsatı değerlendir.',
  ...
  75: CardMeaning(id: 75, themeTr: 'Sabırlı ilerleme, güvenilir güç, istikrar', themeEn: 'Patient progress, reliable strength, stability', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Ağır adımlarla yürüyen atın üzerindeki şövalye, elindeki tılsımye dikkatle bakmış. Tarlalar ve tepeler geçtikçe, sabırlı ama kararlı adımlarla hedefe yaklaşmışsın.',
