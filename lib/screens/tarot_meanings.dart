...
List<CardSymbol> getCardSymbols(int cardId) {
  const majorSymbols = <int, List<CardSymbol>>{
    ...
    13: [ // Death
      CardSymbol(emoji: '🐴', nameTr: 'At', nameEn: 'Horse', meaningsTr: ['Güçlü gelen dönüşüm', 'Kaçınılmaz değişimin', 'Eskiye veda edişin'], meaningsEn: ['Change comes with force']),
  ...
  const minorSpecificSymbols = <int, List<CardSymbol>>{
    ...
    64: [ // Ace of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Maddi bereketin filizi'], meaningsEn: ['The seed of your material abundance']),
    ...
    65: [ // Two of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['İş hayatının dengesi'], meaningsEn: ['The balance of your work life']),
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Özel hayatının dengesi'], meaningsEn: ['The balance of your personal life']),
    ...
    66: [ // Three of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['İlk somut başarıların'], meaningsEn: ['Your first concrete achievements']),
    ...
    67: [ // Four of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Başındaki Tılsım', nameEn: 'Coin on Head', meaningsTr: ['Zihinsel takıntıların'], meaningsEn: ['Your mental obsessions']),
      CardSymbol(emoji: '🪙', nameTr: 'Kalbindeki Tılsım', nameEn: 'Coin on Heart', meaningsTr: ['Kalbini kapadığın şeyler'], meaningsEn: ['Things you closed your heart to']),
      CardSymbol(emoji: '🪙', nameTr: 'Ayaktaki Tılsımlar', nameEn: 'Coins at Feet', meaningsTr: ['Güvenlik ihtiyacın çok yüksek'], meaningsEn: ['Your need for security is very high']),
    ...
    68: [ // Five of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['Manevi zenginliğine dön'], meaningsEn: ['Return to your spiritual richness']),
    ...
    69: [ // Six of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['Sana gelen bolluk'], meaningsEn: ['Abundance coming to you']),
    ...
    70: [ // Seven of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['Emeğinin görünen sonuçları'], meaningsEn: ['You see the results of your efforts']),
    ...
    71: [ // Eight of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'İşlenen Tılsım', nameEn: 'Carved Coin', meaningsTr: ['Her detaya verdiğin emek'], meaningsEn: ['The effort you give to every detail']),
      CardSymbol(emoji: '🪙', nameTr: 'Tamamlanan Tılsımlar', nameEn: 'Completed Coins', meaningsTr: ['Biriken deneyim ve beceri'], meaningsEn: ['Accumulating experience and skill']),
    ...
    72: [ // Nine of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['Maddi bağımsızlığın'], meaningsEn: ['Your financial independence']),
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Ruhani zenginliğin de var'], meaningsEn: ['You also have spiritual wealth']),
    ],
    73: [ // Ten of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsımlar', nameEn: 'Coins', meaningsTr: ['Kurulan kalıcı zenginlik'], meaningsEn: ['You are building lasting wealth']),
    ...
    74: [ // Page of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Dikkatli ve planlı adımların'], meaningsEn: ['Your careful and planned steps']),
    ...
    75: [ // Knight of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Maddi hedeflerine odağın'], meaningsEn: ['Your focus on material goals']),
    ...
    76: [ // Queen of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Taşan koruyucu bereketin'], meaningsEn: ['Your protective blessings overflow']),
    ...
    77: [ // King of Pentacles
      ...
      CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Dorukta olan finansal gücün'], meaningsEn: ['Your financial power is at its peak']),
  ...
  final suitSymbols = <List<CardSymbol>>[
    ...
    [ // Pentacles
      const CardSymbol(emoji: '🪙', nameTr: 'Tılsım', nameEn: 'Coin', meaningsTr: ['Somut sonuçların'], meaningsEn: ['Your tangible results']),
...
const Map<int, CardMeaning> cardMeanings = {
  ...
  13: CardMeaning(
    ...
    pastTr: 'Geri döndürülemez bir dönüşüm rüzgarı hayatından esip geçmiş; eski düzenin tamamen yıkılmış ve sana hizmet etmeyen alışkanlıkların yeryüzünden silinmiş.',
    pastEn: 'An irreversible transformation swept through your life; the old order has completely collapsed and habits that no longer serve you were wiped from the earth.',
  ...
  44: CardMeaning(id: 44, themeTr: 'Son direnç, yorgun savaşçı, dayanıklılık', themeEn: 'Last stand, weary warrior, endurance', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Bandajlı başıyla asasına dayanan savaşçı, arkasında duvar gibi yükselen asaların önünde nöbet tutmuş. Yorgun düşmüşsün ama asla dizlerinin üstüne çökmemişsin.',
    pastEn: 'The bandaged warrior leaned on his wand, standing guard before the wall of wands rising behind him. You grew weary but never fell to your knees.',
    presentTr: 'Yaralarına rağmen ayaktasın. Arkanda sağlamca duran asalar senin savunma hattın. Son bir sınav daha var ama sen buna hazırsın — çünkü şimdiye kadar hepsini atlattın.',
    presentEn: 'Despite your wounds, you stand. The firmly standing wands behind you are your line of defense. One more test remains, but you are ready — you survived them all so far.',
  ...
  51: CardMeaning(id: 51, themeTr: 'İkilem, inkâr, ertelenmiş karar', themeEn: 'Dilemma, denial, postponed decision', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    ...
    directionTr: 'Mantığının yarattığı o kördüğümü çöz. Ertelediğin her karar aslında ruhunu daha fazla esir alıyor. Yanlış bile olsa harekete geç, çünkü eylemsizlik en büyük tuzaktır.',
  ...
  64: CardMeaning(id: 64, themeTr: 'Maddi fırsat, yeni başlangıç, bereket kapısı', themeEn: 'Material opportunity, new start, abundance gate', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Bulutlardan uzanan el, altın bir tılsım sunmuş. Bahçenin kapısındaki çiçekli kemerin altından o fırsatı almışsın ve maddi dünyada ilk adımını atmışsın.',
    ...
    presentTr: 'Altın tılsım avucunda parlıyor ve bahçenin kapısı açık. Maddi bir fırsat seni bekliyor. Bu tohumun ekilme zamanı — bereket bahçesine adım at.',
    ...
    directionTr: 'Tılsımı cebine koyma, toprağa ek. Fırsatı değerlendir ve o bahçeyi büyüt. Bereket kapısı açık ama sonsuza dek açık kalmayacak.',
  ...
  65: CardMeaning(id: 65, themeTr: 'Denge cambazlığı, uyum arayışı, esneklik', themeEn: 'Juggling balance, seeking harmony, flexibility', tone: CardTone.decision, movement: CardMovement.motion, phase: CardPhase.neutral,
    pastTr: 'Genç jonglör iki tılsımyi sonsuzluk bandıyla çevirirken, arka plandaki dalgalı deniz hayatın inişli çıkışlı dönemini yansıtıyormuş. O dengeleme sanatını sen de öğrenmişsin.',
    ...
    presentTr: 'İki tılsımyi havada döndürüyorsun — iş ve özel hayat, vermek ve almak. Dalgalar arkanda yükseliyor ama sen dengedesin. Bu cambazlığın ustası sensin.',
  ...
  66: CardMeaning(id: 66, themeTr: 'Ustalık, takım çalışması, ilk meyveler', themeEn: 'Mastery, teamwork, first fruits', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Usta, kemerli katedralin içinde iki mimarla birlikte çalışmış. Planlar incelenirken üç tılsım taş kemerden parlamış. İş birliğiyle büyük eserler yaratmışsın.',
    ...
    presentTr: 'Bir takımın parçasısın ve herkesin uzmanlığı bütünü güçlendiriyor. Üç tılsım kemerde parlıyor — emeğinin ilk somut sonuçları görünüyor. Ustalığın takdir ediliyor.',
  ...
  67: CardMeaning(id: 67, themeTr: 'Kontrol tutkusu, güvensizlik, kapalılık', themeEn: 'Control obsession, insecurity, closedness', tone: CardTone.heavy, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Tahtında oturan figür, bir tılsımyi başının üstünde dengelerken diğerlerini ayaklarının altında ve kollarının arasında sıkıca tutmuş. Kaybetme korkusu seni esir almış.',
    ...
    presentTr: 'Dört tılsımyi kucaklıyorsun ama hiçbirinden keyif alamıyorsun. Kontrolü bırakamıyorsun çünkü güvensizlik seni ele geçirmiş. Arkandaki şehri görmüyorsun — hayat dışarıda akıyor.',
    ...
    directionTr: 'Bir tılsımyi bırak ve ne olduğunu gör. Kaybetme korkusu, sahip olduklarından daha pahalıya patlıyor. Elini aç, bolluk açık avuca gelir.',
  ...
  68: CardMeaning(id: 68, themeTr: 'Zorluk, dışlanma, gizli destek', themeEn: 'Hardship, exclusion, hidden support', tone: CardTone.heavy, movement: CardMovement.motion, phase: CardPhase.neutral,
    ...
    presentTr: 'Soğuk ve karın ortasındasın. Beş tılsım pencerenin üzerinde parlıyor ama sen onları göremiyorsun. Maddi zorluk yaşıyorsun ama fark etmediğin bir destek çok yakınında.',
  ...
  69: CardMeaning(id: 69, themeTr: 'Cömertlik, adil paylaşım, karşılıklı yarar', themeEn: 'Generosity, fair sharing, mutual benefit', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Terazisini tutan zengin tüccar, diz çökmüş iki figüre altın tılsımler dağıtmış. Sen de bir zamanlar ya veren ya da alan olmuşsun — ve bu denge hayatını şekillendirmiş.',
    ...
    presentTr: 'Terazin dengede ve ellerin dolu. Altı tılsım paylaşılmayı bekliyor. Cömertlik döngüsünde yerini al — veren el alan elden üstündür ama ikisi de kutsaldır.',
  ...
  70: CardMeaning(id: 70, themeTr: 'Sabır, yatırım, bekleme bilgeliği', themeEn: 'Patience, investment, wisdom of waiting', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Çapa dayanmış çiftçi, asmanın üzerindeki yedi tılsıma bakmış ve hasadın zamanını beklemiş. Sen de bir zamanlar o sabırlı çiftçi gibi emeğinin meyvesini beklemişsin.',
    ...
    presentTr: 'Yedi tılsım dalda olgunlaşıyor ama henüz hasat zamanı değil. Asmanın üzerindeki meyveler sana bakıyor — sabır mı yoksa acele mi? Başarı doğru zamanda toplamaktadır.',
  ...
  71: CardMeaning(id: 71, themeTr: 'Özveri, ustalık yolu, detay odaklılık', themeEn: 'Dedication, path to mastery, attention to detail', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Çalışma tezgahında oturan zanaatçı, her tılsımyi aynı titizlikle oymuş. Sekiz tılsım duvarda asılıydı — her biri bir adımdı ustalık merdiveninde. Özveriyle çalıştın ve becerilerini bilemişsin.',
    ...
    presentTr: 'Tezgahındasın ve elindeki aletle bir tılsım daha oyuyorsun. Sekiz merdiven basamağının altıncısındasın. Ustalık yolunda sabrın ve özenin meyvelerini toplamaya başlıyorsun.',
    ...
    directionTr: 'Her detaya aynı özeni ver. Zanaatçının sekiz tılsımı gibi, tekrar tekrar yap ama her seferinde daha iyi yap. Ustalık bir an değil, bir süreçtir.',
  ...
  72: CardMeaning(id: 72, themeTr: 'Bağımsızlık, lüks, kendi kendine yetme', themeEn: 'Independence, luxury, self-sufficiency', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Zarif kadın, üzüm bağlarının ortasındaki bahçesinde yürürken elindeki şahini okşamış. Dokuz tılsım etrafında parlamış. Kendi ellerin ile inşa ettiğin bağımsızlık sana huzur vermiş.',
  ...
  73: CardMeaning(id: 73, themeTr: 'Kalıcı miras, nesiller arası bağ, köklü refah', themeEn: 'Lasting legacy, generational bond, rooted prosperity', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Kemerli taş kapının önünde üç nesil bir araya gelmiş. On altın tılsım bu köklü ailenin sarsılmaz bağını aydınlatmış. Kurduğun miras nesilden nesile aktarılacak kadar güçlenmiş.',
    ...
    presentTr: 'On tılsım seni ve aileni sarıyor. Kale kapısının altındasın ve nesiller arası bağ güçlü. Kurduğun düzen, sadece bugün için değil, gelecek nesiller için de parlıyor.',
  ...
  74: CardMeaning(id: 74, themeTr: 'Yeni öğrenme, pratik hayal, dikkatli adım', themeEn: 'New learning, practical dream, careful step', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.beginning,
    pastTr: 'Yeşil otların üzerinde yürüyen genç, elindeki tılsıma hayalci bir gözle bakmış. Uzaktaki dağlar hedefini, ayaklarının altındaki toprak ise sabırlı adımlarının simgesiymiş.',
    ...
    presentTr: 'Tılsımı ellerinde tutuyorsun ve geleceği hayal ediyorsun. Ama bu boş bir rüya değil — ayakların yerde, gözlerin ufukta. Pratik bir hayalperestsin ve bu mükemmel bir denge.',
    ...
    directionTr: 'Hayalini tılsıma çevir. Adım adım, sabırla ve dikkatle ilerle. Genç öğrencinin merakıyla her fırsatı değerlendir.',
  ...
  75: CardMeaning(id: 75, themeTr: 'Sabırlı ilerleme, güvenilir güç, istikrar', themeEn: 'Patient progress, reliable strength, stability', tone: CardTone.decision, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Ağır adımlarla yürüyen atın üzerindeki şövalye, elindeki tılsıma dikkatle bakmış. Tarlalar ve tepeler geçtikçe, sabırlı ama kararlı adımlarla hedefe yaklaşmışsın.',
    ...
    presentTr: 'Atın yavaş ama sağlam adımlarla ilerliyor. Elindeki tılsım maddi hedefini simgeliyor. Hızlı değilsin ama güvenilirsin — ve bu sarsılmaz istikrarın seni çok daha güçlü kılıyor.',
  ...
  76: CardMeaning(id: 76, themeTr: 'Şefkatli bolluk, toprak anası, koruyucu bereket', themeEn: 'Compassionate abundance, earth mother, protective blessing', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.neutral,
    pastTr: 'Gül bahçesinin ortasındaki tahtında oturan kraliçe, kucağındaki tılsımyi bir bebek gibi sevgiyle tutmuş. Tavşan ayaklarının dibinde oturmuş. Bereket ve şefkatin birleştiği o dönem seni beslemiş.',
    ...
    presentTr: 'Gül bahçenin ortasındasın ve kucağındaki tılsım hem maddi hem manevi bolluğu temsil ediyor. Tavşanın doğurganlığı, sütunların sağlamlığı — her şey yerinde ve bereketli.',
    ...
    directionTr: 'Kraliçenin tılsımyi koruduğu gibi nimetlerini koru ama paylaş. Bolluk paylaşıldıkça çoğalır. Toprak anası gibi besle, büyüt ve koru.',
  ...
  77: CardMeaning(id: 77, themeTr: 'Maddi zirve, kalıcı başarı, miras bırakan güç', themeEn: 'Material peak, lasting success, legacy-building power', tone: CardTone.soft, movement: CardMovement.stillness, phase: CardPhase.completion,
    pastTr: 'Üzüm bağlarıyla çevrili kalesinin önündeki kralın cüppesini altın tılsımler süslemiş. Boğa başlı tahtında oturan bu hükümdar, maddi dünyayı fethetmiş. Sen de öyle.',
    ...
    presentTr: 'Kralın tahtındasın — üzüm bağlarının, kalelerinin ve altın tılsımlerinin arasında. Maddi zirvedesin ve herkes sana saygıyla bakıyor. Bu başarıyı kalıcı kıl.',
    ...
    directionTr: 'Başarının tadını çıkar ama onu miras olarak bırakmayı da planla. Kralın tılsımlerini sayma, onlarla imparatorluk kur. Bağını büyüt, mirasını koru.',
  ...
  switch (flow) {
    case FlowType.harmonious:
      pool = isTr ? [
        ...
        'Düğümler birer birer çözülüyor ve hayatın doğal ritmi yeniden başlıyor. Direnci bırak; su yolunu çoktan buldu.',
      ] : [
...
List<CardRelation> _analyzeCardRelations(List<CardMeaning> meanings, List<String> names, bool isTr) {
  ...
  if (relations.length < 2) {
    final fallbackTr = [
      ...
      'zihnindeki kördüğümü yavaşça çözüyor. Buna sadece izin ver.',
    ];
    final fallbackEn = [
