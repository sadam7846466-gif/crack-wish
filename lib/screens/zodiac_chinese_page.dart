...
class _TimingIconPainter extends CustomPainter {
  ...
  void _trending(Canvas c,double w,double h,Paint p,Paint f){final path=Path()..moveTo(w*.1,h*.75)..cubicTo(w*.3,h*.7,w*.4,h*.45,w*.55,h*.4)..cubicTo(w*.7,h*.35,w*.8,h*.2,w*.9,h*.15);c.drawPath(path,p);c.drawLine(Offset(w*.75,h*.12),Offset(w*.92,h*.12),p..strokeWidth=0.9);c.drawLine(Offset(w*.92,h*.12),Offset(w*.92,h*.3),p);c.drawCircle(Offset(w*.9,h*.15),2,f);}
  void _bank(Canvas c,double w,double h,Paint p){final roof=Path()..moveTo(w*.5,h*.05)..lineTo(w*.95,h*.3)..lineTo(w*.05,h*.3)..close();c.drawPath(roof,p);c.drawLine(Offset(w*.2,h*.35),Offset(w*.2,h*.75),p);c.drawLine(Offset(w*.4,h*.35),Offset(w*.4,h*.75),p);c.drawLine(Offset(w*.6,h*.35),Offset(w*.6,h*.75),p);c.drawLine(Offset(w*.8,h*.35),Offset(w*.8,h*.75),p);c.drawLine(Offset(w*.05,h*.8),Offset(w*.95,h*.8),p);c.drawLine(Offset(w*.05,h*.9),Offset(w*.95,h*.9),p..strokeWidth=1.5);}
  ...
  void _briefcase(Canvas c,double w,double h,Paint p){c.drawRRect(RRect.fromLTRBR(w*.08,h*.18,w*.92,h*.88,const Radius.circular(4)),p..strokeWidth=1.2);c.drawRRect(RRect.fromLTRBR(w*.08,h*.18,w*.92,h*.35,const Radius.circular(4)),p..strokeWidth=0.8);c.drawLine(Offset(w*.08,h*.35),Offset(w*.92,h*.35),p..strokeWidth=0.5);c.drawCircle(Offset(w*.5,h*.58),w*.13,p..strokeWidth=1.0);c.drawLine(Offset(w*.5,h*.5),Offset(w*.5,h*.55),p..strokeWidth=0.8);c.drawCircle(Offset(w*.5,h*.58),w*.04,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);c.drawCircle(Offset(w*.5,h*.27),w*.04,p..strokeWidth=0.6);}
  void _handshake(Canvas c,double w,double h,Paint p,Paint f){final lp=Path()..moveTo(w*.05,h*.25)..lineTo(w*.45,h*.25)..lineTo(w*.45,h*.5)..cubicTo(w*.45,h*.55,w*.35,h*.55,w*.35,h*.5)..lineTo(w*.35,h*.45)..lineTo(w*.05,h*.45)..close();c.drawPath(lp,p);c.drawPath(lp,Paint()..color=color.withOpacity(0.08)..style=PaintingStyle.fill);final rp=Path()..moveTo(w*.55,h*.3)..lineTo(w*.95,h*.3)..lineTo(w*.95,h*.75)..lineTo(w*.55,h*.75)..lineTo(w*.55,h*.55)..cubicTo(w*.55,h*.5,w*.65,h*.5,w*.65,h*.55)..lineTo(w*.65,h*.58)..lineTo(w*.55,h*.58)..close();c.drawPath(rp,p);c.drawPath(rp,Paint()..color=color.withOpacity(0.08)..style=PaintingStyle.fill);c.drawCircle(Offset(w*.5,h*.5),w*.04,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);}
  ...
  void _tent(Canvas c,double w,double h,double cx,Paint p){final t=Path()..moveTo(cx,h*.08)..lineTo(w*.78,h*.55)..lineTo(w*.65,h*.55)..lineTo(cx,h*.25)..lineTo(w*.35,h*.55)..lineTo(w*.22,h*.55)..close();c.drawPath(t,p);c.drawLine(Offset(cx,h*.08),Offset(cx,h*.55),p..strokeWidth=0.6);c.drawRect(Rect.fromLTWH(w*.44,h*.38,w*.12,h*.17),p..strokeWidth=0.5);c.drawLine(Offset(w*.28,h*.68),Offset(w*.72,h*.68),p..strokeWidth=1.0);c.drawLine(Offset(w*.35,h*.68),Offset(w*.35,h*.78),p..strokeWidth=0.8);c.drawLine(Offset(w*.65,h*.68),Offset(w*.65,h*.78),p);final fire=Path()..moveTo(w*.5,h*.78)..cubicTo(w*.45,h*.7,w*.42,h*.65,w*.48,h*.62)..cubicTo(w*.52,h*.65,w*.55,h*.7,w*.5,h*.78);c.drawPath(fire,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);c.drawPath(fire,p..strokeWidth=0.7);c.drawCircle(Offset(w*.5,h*.68),1,Paint()..color=color.withOpacity(0.5)..style=PaintingStyle.fill);}
  ...
  void _couple(Canvas c,double w,double h,double cx,Paint p,Paint f){c.drawCircle(Offset(w*.3,h*.2),w*.1,p);c.drawLine(Offset(w*.3,h*.32),Offset(w*.3,h*.7),p);c.drawCircle(Offset(w*.7,h*.2),w*.1,p);c.drawLine(Offset(w*.7,h*.32),Offset(w*.7,h*.7),p);_drawH(c,cx,h*.55,w*.1,p..strokeWidth=0.8);}
  void _giftHeart(Canvas c,double w,double h,double cx,double cy,Paint p,Paint f){_drawH(c,cx,cy,w*.3,p);c.drawLine(Offset(cx-w*.15,cy-h*.12),Offset(cx,cy-h*.3),p..strokeWidth=0.8);c.drawLine(Offset(cx+w*.15,cy-h*.12),Offset(cx,cy-h*.3),p);c.drawCircle(Offset(cx,cy-h*.3),2,f);}
  ...
  void _meditate(Canvas c,double w,double h,double cx,double cy,Paint p){c.drawCircle(Offset(cx,cy),w*.42,Paint()..color=color.withOpacity(0.08)..style=PaintingStyle.stroke..strokeWidth=0.6);c.drawCircle(Offset(cx,cy-h*.05),w*.32,Paint()..color=color.withOpacity(0.05)..style=PaintingStyle.stroke..strokeWidth=0.5);c.drawCircle(Offset(cx,h*.16),w*.09,p);c.drawLine(Offset(cx,h*.26),Offset(cx,h*.5),p);final lg=Path()..moveTo(w*.2,h*.68)..cubicTo(w*.28,h*.52,w*.72,h*.52,w*.8,h*.68);c.drawPath(lg,p);c.drawLine(Offset(cx,h*.36),Offset(w*.22,h*.46),p..strokeWidth=0.9);c.drawLine(Offset(cx,h*.36),Offset(w*.78,h*.46),p);for(int i=0;i<5;i++){final a=-math.pi/2+i*(math.pi/4);c.drawCircle(Offset(cx+w*.32*math.cos(a),h*.48+w*.18*math.sin(a)),0.8,Paint()..color=color.withOpacity(0.15+i*0.04)..style=PaintingStyle.fill);}}
  ...
  void _party(Canvas c,double w,double h,double cx,Paint p,Paint f){final burst=Path()..moveTo(cx,h*.15)..lineTo(cx+w*.06,h*.28)..lineTo(cx+w*.2,h*.22)..lineTo(cx+w*.12,h*.35)..lineTo(cx+w*.28,h*.4)..lineTo(cx+w*.12,h*.48)..lineTo(cx+w*.2,h*.62)..lineTo(cx+w*.06,h*.55)..lineTo(cx,h*.7)..lineTo(cx-w*.06,h*.55)..lineTo(cx-w*.2,h*.62)..lineTo(cx-w*.12,h*.48)..lineTo(cx-w*.28,h*.4)..lineTo(cx-w*.12,h*.35)..lineTo(cx-w*.2,h*.22)..lineTo(cx-w*.06,h*.28)..close();c.drawPath(burst,p..strokeWidth=0.9);c.drawPath(burst,Paint()..color=color.withOpacity(0.08)..style=PaintingStyle.fill);c.drawCircle(Offset(cx,h*.42),w*.08,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);c.drawCircle(Offset(w*.2,h*.78),1.5,f);c.drawCircle(Offset(w*.75,h*.82),1.2,f);c.drawCircle(Offset(w*.82,h*.72),1,f);}
  void _toast(Canvas c,double w,double h,double cx,Paint p){final bot=Path()..moveTo(w*.1,h*.92)..lineTo(w*.1,h*.45)..cubicTo(w*.1,h*.25,w*.42,h*.25,w*.42,h*.45)..lineTo(w*.42,h*.92);c.drawPath(bot,p..strokeWidth=1.1);c.drawLine(Offset(w*.15,h*.6),Offset(w*.38,h*.6),p..strokeWidth=0.4);final cork=Path()..moveTo(w*.22,h*.25)..cubicTo(w*.2,h*.15,w*.15,h*.05,w*.1,h*.02);c.drawPath(cork,p..strokeWidth=0.8);c.drawCircle(Offset(w*.1,h*.02),1.5,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);for(int i=0;i<5;i++){c.drawCircle(Offset(w*(.15+i*.06),h*(.08+i*.04)),1.0-i*0.1,Paint()..color=color.withOpacity(0.25-i*0.03)..style=PaintingStyle.fill);}final star=Path()..moveTo(w*.7,h*.2)..lineTo(w*.73,h*.28)..lineTo(w*.82,h*.3)..lineTo(w*.75,h*.36)..lineTo(w*.77,h*.45)..lineTo(w*.7,h*.4)..lineTo(w*.63,h*.45)..lineTo(w*.65,h*.36)..lineTo(w*.58,h*.3)..lineTo(w*.67,h*.28)..close();c.drawPath(star,p..strokeWidth=0.7);c.drawPath(star,Paint()..color=color.withOpacity(0.15)..style=PaintingStyle.fill);}
  ...
  void _medal(Canvas c,double w,double h,double cx,Paint p,Paint f){c.drawLine(Offset(w*.3,h*.05),Offset(cx,h*.35),p..strokeWidth=0.9);c.drawLine(Offset(w*.7,h*.05),Offset(cx,h*.35),p);c.drawCircle(Offset(cx,h*.6),w*.25,p..strokeWidth=1.2);for(int i=0;i<5;i++){final a=(2*math.pi*i/5)-math.pi/2;c.drawLine(Offset(cx+w*.12*math.cos(a),h*.6+w*.12*math.sin(a)),Offset(cx+w*.2*math.cos(a),h*.6+w*.2*math.sin(a)),p..strokeWidth=0.7);}c.drawCircle(Offset(cx,h*.6),2,f);}
  ...
  void _bulb(Canvas c,double w,double h,double cx,Paint p,Paint f){c.drawCircle(Offset(cx,h*.3),w*.25,p);c.drawLine(Offset(w*.37,h*.5),Offset(w*.37,h*.62),p..strokeWidth=0.8);c.drawLine(Offset(w*.63,h*.5),Offset(w*.63,h*.62),p);c.drawLine(Offset(w*.4,h*.62),Offset(w*.6,h*.62),p..strokeWidth=0.5);c.drawLine(Offset(w*.42,h*.66),Offset(w*.58,h*.66),p);c.drawLine(Offset(w*.47,h*.7),Offset(w*.53,h*.7),p);final rk=Path()..moveTo(cx,h*.18)..lineTo(cx-w*.06,h*.28)..lineTo(cx-w*.03,h*.28)..lineTo(cx-w*.03,h*.42)..lineTo(cx+w*.03,h*.42)..lineTo(cx+w*.03,h*.28)..lineTo(cx+w*.06,h*.28)..close();c.drawPath(rk,Paint()..color=color.withOpacity(0.3)..style=PaintingStyle.fill);c.drawPath(rk,p..strokeWidth=0.6);c.drawCircle(Offset(cx,h*.3),w*.12,Paint()..color=color.withOpacity(0.06)..maskFilter=const MaskFilter.blur(BlurStyle.normal,4));for(int i=0;i<3;i++){final a=(-math.pi*0.7)+i*(math.pi*0.35);c.drawLine(Offset(cx+w*.27*math.cos(a),h*.3+w*.27*math.sin(a)),Offset(cx+w*.38*math.cos(a),h*.3+w*.38*math.sin(a)),p..strokeWidth=0.5);}}
  ...
  void _muscle(Canvas c,double w,double h,Paint p){final mt=Path()..moveTo(w*.08,h*.88)..lineTo(w*.35,h*.35)..lineTo(w*.5,h*.55)..lineTo(w*.7,h*.15)..lineTo(w*.92,h*.88);c.drawPath(mt,p..strokeWidth=1.2);c.drawLine(Offset(w*.08,h*.88),Offset(w*.92,h*.88),p..strokeWidth=0.6);final flag=Path()..moveTo(w*.7,h*.15)..lineTo(w*.7,h*.02)..lineTo(w*.85,h*.08)..lineTo(w*.7,h*.15);c.drawPath(flag,Paint()..color=color.withOpacity(0.35)..style=PaintingStyle.fill);c.drawPath(flag,p..strokeWidth=0.7);c.drawCircle(Offset(w*.7,h*.02),1,Paint()..color=color.withOpacity(0.5)..style=PaintingStyle.fill);}
  ...
  void _chess(Canvas c,double w,double h,double cx,Paint p,Paint f){final board=Path()..moveTo(w*.1,h*.7)..lineTo(w*.3,h*.3)..lineTo(w*.9,h*.3)..lineTo(w*.7,h*.7)..close();c.drawPath(board,p);c.drawLine(Offset(w*.5,h*.3),Offset(w*.4,h*.7),p..strokeWidth=0.5);c.drawLine(Offset(w*.7,h*.3),Offset(w*.55,h*.7),p);c.drawLine(Offset(w*.36,h*.5),Offset(w*.76,h*.5),p);for(int i=0;i<3;i++){for(int j=0;j<2;j++){if((i+j)%2==0){final x=w*(.33+i*.13)-j*w*.06;final y=h*(.35+j*.2);c.drawRect(Rect.fromLTWH(x,y,w*.1,h*.12),Paint()..color=color.withOpacity(0.12)..style=PaintingStyle.fill);}}}final pawn=Path()..moveTo(w*.55,h*.15)..cubicTo(w*.52,h*.12,w*.48,h*.12,w*.45,h*.15)..lineTo(w*.42,h*.22)..lineTo(w*.58,h*.22)..close();c.drawPath(pawn,p..strokeWidth=0.8);c.drawCircle(Offset(w*.5,h*.12),w*.04,p);}
  ...
  void _hands(Canvas c,double w,double h,double cx,Paint p){for(int i=0;i<3;i++){final x=w*(0.2+i*0.25);final y=h*(i==1?0.32:0.4);c.drawCircle(Offset(x,y),w*.08,p);c.drawLine(Offset(x,y+w*.08),Offset(x,y+w*.28),p);c.drawLine(Offset(x,y+w*.15),Offset(x-w*.08,y+w*.22),p..strokeWidth=0.7);c.drawLine(Offset(x,y+w*.15),Offset(x+w*.08,y+w*.22),p);}c.drawLine(Offset(w*.28,h*.52),Offset(w*.42,h*.45),Paint()..color=color.withOpacity(0.3)..style=PaintingStyle.stroke..strokeWidth=0.7);c.drawLine(Offset(w*.58,h*.45),Offset(w*.72,h*.52),Paint()..color=color.withOpacity(0.3)..style=PaintingStyle.stroke..strokeWidth=0.7);c.drawCircle(Offset(cx,h*.12),w*.06,Paint()..color=color.withOpacity(0.2)..maskFilter=const MaskFilter.blur(BlurStyle.normal,3));}
  ...
  void _ribbon(Canvas c,double w,double h,double cx,Paint p){final ht=Path()..moveTo(cx,h*.12)..cubicTo(cx-w*.12,h*.06,cx-w*.2,h*.14,cx-w*.15,h*.22)..lineTo(cx,h*.38)..lineTo(cx+w*.15,h*.22)..cubicTo(cx+w*.2,h*.14,cx+w*.12,h*.06,cx,h*.12);c.drawPath(ht,Paint()..color=color.withOpacity(0.3)..style=PaintingStyle.fill);c.drawPath(ht,p..strokeWidth=0.9);final lr=Path()..moveTo(cx-w*.08,h*.38)..cubicTo(cx-w*.18,h*.5,cx-w*.25,h*.65,cx-w*.15,h*.88);c.drawPath(lr,p..strokeWidth=1.0);final rr=Path()..moveTo(cx+w*.08,h*.38)..cubicTo(cx+w*.18,h*.5,cx+w*.25,h*.65,cx+w*.15,h*.88);c.drawPath(rr,p);c.drawCircle(Offset(cx,h*.22),1,Paint()..color=color.withOpacity(0.5)..style=PaintingStyle.fill);}
  ...
  void _savings(Canvas c,double w,double h,double cx,Paint p,Paint f){c.drawRRect(RRect.fromLTRBR(w*.12,h*.15,w*.88,h*.85,const Radius.circular(4)),p..strokeWidth=1.2);c.drawRRect(RRect.fromLTRBR(w*.12,h*.15,w*.88,h*.35,const Radius.circular(4)),p..strokeWidth=0.8);c.drawLine(Offset(w*.12,h*.35),Offset(w*.88,h*.35),p..strokeWidth=0.6);c.drawCircle(Offset(cx,h*.58),w*.15,p..strokeWidth=1.0);c.drawCircle(Offset(cx,h*.58),w*.08,p..strokeWidth=0.6);c.drawCircle(Offset(cx,h*.58),1.5,f);c.drawLine(Offset(cx-w*.02,h*.52),Offset(cx+w*.02,h*.52),p..strokeWidth=0.5);c.drawLine(Offset(cx,h*.5),Offset(cx,h*.54),p);c.drawCircle(Offset(w*.8,h*.25),w*.05,p..strokeWidth=0.7);c.drawCircle(Offset(w*.8,h*.25),1,f);}
  void _weddingRing(Canvas c,double w,double h,double cx,double cy,Paint p,Paint f){c.drawCircle(Offset(cx,h*.58),w*.28,p);c.drawCircle(Offset(cx,h*.58),w*.2,p..strokeWidth=0.5);final dm=Path()..moveTo(cx,h*.15)..lineTo(cx-w*.15,h*.32)..lineTo(cx-w*.08,h*.32)..lineTo(cx,h*.22)..lineTo(cx+w*.08,h*.32)..lineTo(cx+w*.15,h*.32)..close();c.drawPath(dm,Paint()..color=color.withOpacity(0.4)..style=PaintingStyle.fill);c.drawPath(dm,p..strokeWidth=0.8);c.drawCircle(Offset(cx,h*.1),1,f);c.drawLine(Offset(cx-w*.08,h*.08),Offset(cx+w*.08,h*.08),p..strokeWidth=0.4);c.drawLine(Offset(cx,h*.04),Offset(cx,h*.12),p);}
  @override
  bool shouldRepaint(covariant CustomPainter oldDelegate) => false;
}
