        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, pageIndex) {
              final cr = reading.cardReadings[pageIndex];
              final cardAsset = _allCards[_selectedCardIndexes[pageIndex]].frontAsset;
              final accentColor = positionColors[pageIndex];
              final posIcon = positionIcons[pageIndex];

              // Kartın gerçek sembollerini al
              final cardId = _selectedCardIndexes[pageIndex];
              final symbols = getCardSymbols(cardId);

              // Her sembol için farklı renk tonu
              final hsl = HSLColor.fromColor(accentColor);


              Color branchColorFor(int idx) => idx == 0
                  ? accentColor
                  : hsl.withHue((hsl.hue + idx * 28) % 360)
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            ...
                            const Color(0xFF0E0A1A).withValues(alpha: 0.78),
                            const Color(0xFF12091E).withValues(alpha: 0.88),
                          ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Text(posIcon, style: const TextStyle(fontSize: 12)),
                                  const SizedBox(width: 5),
                                  Text(
                                    cr.positionTitle.toUpperCase(),
                                    style: TextStyle(
                                      color: accentColor,
                                      fontSize: 10,
                                      fontWeight: FontWeight.w700,
                            ...
                            // Sembol dalları — sol/sağ alternating
                            ...symbols.asMap().entries.map((entry) {
                              final idx = entry.key;
                              final symbol = entry.value;
                              final isLeft = idx.isEven;
                              final isLast = idx == symbols.length - 1;
                              final bc = branchColorFor(idx);

                              // Emoji düğüm
                              final emojiNode = Container(
                                width: 40, height: 40,
                                decoration: BoxDecoration(
                                  shape: BoxShape.circle,
                                  color: bc.withValues(alpha: 0.08),
                                  border: Border.all(color: bc.withValues(alpha: 0.55), width: 1.8),
                                  boxShadow: [
                                    BoxShadow(color: bc.withValues(alpha: 0.22), blurRadius: 12, spreadRadius: 1),
                                  ],
                                ),
                                alignment: Alignment.center,
                                child: Text(symbol.emoji, style: const TextStyle(fontSize: 18)),
                              );
                              ...
                              final textContent = Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _isTr ? symbol.nameTr : symbol.nameEn,
                                      style: TextStyle(
                                        color: bc,
                                        fontSize: 13,
                                        fontWeight: FontWeight.w700,
                                    ...
                                    const SizedBox(height: 2),
                                    Text(
                                      _isTr ? symbol.meaningTr : symbol.meaningEn,
                                      style: GoogleFonts.lora(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: LinearGradient(
                                        colors: isLeft
                                          ? [bc.withValues(alpha: 0.10), bc.withValues(alpha: 0.55)]
                                          : [bc.withValues(alpha: 0.55), bc.withValues(alpha: 0.10)],
                                      ),
                                    ),
                                  ),
                                ],
                                ...
                                child: Column(
                                  children: [
                                    Expanded(child: Container(
                                      width: 1.5,
                                      color: bc.withValues(alpha: 0.25),
                                    )),
                                    Container(
                                      width: 7, height: 7,
                                      decoration: BoxDecoration(
                                    ...
                                    Expanded(child: Container(
                                      width: 1.5,
                                      color: isLast ? Colors.transparent : bc.withValues(alpha: 0.15),
                                    )),
                                  ],
                                ),
                              );
                              ...
                              return IntrinsicHeight(
                                child: Row(
                                  ...
                                  children: isLeft
                                    ? [
                                        // SOL: metin → emoji → connector → omurga → boş
                                        textContent,
                                        const SizedBox(width: 6),
                                        Column(mainAxisAlignment: MainAxisAlignment.center, children: [emojiNode]),
                                        connector,
                                        spine,
                                        const Expanded(child: SizedBox()),
                                      ]
                                    : [
                                        // SAĞ: boş → omurga → connector → emoji → metin
                                        const Expanded(child: SizedBox()),
                                        spine,
                                        connector,
                                        Column(mainAxisAlignment: MainAxisAlignment.center, children: [emojiNode]),
