...
class _TarotPageState extends State<TarotPage> with TickerProviderStateMixin {
  ...
  final List<TarotCardDef> _allCards = [
    ...
    TarotCardDef(
      ...
      nameTr: 'Asaların Ası',
      nameEn: 'Ace of Wands',
      frontAsset: 'assets/images/tarot/tarot/Ace_of_Wands.webp',
    ),
    TarotCardDef(
      id: 37,
      nameTr: 'Asaların İkisi',
      nameEn: 'Two of Wands',
      frontAsset: 'assets/images/tarot/tarot/Two_of_Wands.webp',
    ),
    TarotCardDef(
      id: 38,
      nameTr: 'Asaların Üçü',
      nameEn: 'Three of Wands',
      frontAsset: 'assets/images/tarot/tarot/Three_of_Wands.webp',
    ),
    TarotCardDef(
      id: 39,
    ...
    TarotCardDef(
      id: 40,
      nameTr: 'Asaların Beşi',
      nameEn: 'Five of Wands',
      frontAsset: 'assets/images/tarot/tarot/Five_of_Wands.webp',
    ),
    TarotCardDef(
      id: 41,
      nameTr: 'Asaların Altısı',
      nameEn: 'Six of Wands',
      frontAsset: 'assets/images/tarot/tarot/Six_of_Wands.webp',
    ),
    TarotCardDef(
      id: 42,
      nameTr: 'Asaların Yedisi',
      nameEn: 'Seven of Wands',
      frontAsset: 'assets/images/tarot/tarot/Seven_of_Wands.webp',
    ),
    TarotCardDef(
      id: 43,
      nameTr: 'Asaların Sekizi',
      nameEn: 'Eight of Wands',
      frontAsset: 'assets/images/tarot/tarot/Eight_of_Wands.webp',
    ),
    TarotCardDef(
      id: 44,
      nameTr: 'Asaların Dokuzu',
      nameEn: 'Nine of Wands',
      frontAsset: 'assets/images/tarot/tarot/Nine_of_Wands.webp',
    ),
    TarotCardDef(
      id: 45,
      nameTr: 'Asaların Onu',
      nameEn: 'Ten of Wands',
      frontAsset: 'assets/images/tarot/tarot/Ten_of_Wands.webp',
    ),
    TarotCardDef(
      id: 46,
      nameTr: 'Asaların Uşağı',
      nameEn: 'Page of Wands',
      frontAsset: 'assets/images/tarot/tarot/Page_of_Wands.webp',
    ),
    TarotCardDef(
      id: 47,
      nameTr: 'Asaların Şövalyesi',
      nameEn: 'Knight of Wands',
      frontAsset: 'assets/images/tarot/tarot/Knight_of_Wands.webp',
    ),
    TarotCardDef(
      id: 48,
      nameTr: 'Asaların Kraliçesi',
      nameEn: 'Queen of Wands',
      frontAsset: 'assets/images/tarot/tarot/Queen_of_Wands.webp',
    ),
    TarotCardDef(
      id: 49,
      nameTr: 'Asaların Kralı',
      nameEn: 'King of Wands',
      frontAsset: 'assets/images/tarot/tarot/King_of_Wands.webp',
    ),
    // ============================================================
    ...
    TarotCardDef(
      id: 50,
      nameTr: 'Kılıçların Ası',
      nameEn: 'Ace of Swords',
      frontAsset: 'assets/images/tarot/tarot/Ace_of_Swords.webp',
    ),
    TarotCardDef(
      id: 51,
      nameTr: 'Kılıçların İkisi',
      nameEn: 'Two of Swords',
      frontAsset: 'assets/images/tarot/tarot/Two_of_Swords.webp',
    ),
    TarotCardDef(
      id: 52,
      nameTr: 'Kılıçların Üçü',
      nameEn: 'Three of Swords',
      frontAsset: 'assets/images/tarot/tarot/Three_of_Swords.webp',
    ),
    TarotCardDef(
      id: 53,
  ...
  void initState() {
    ...
    _slotGlowControllers = List.generate(
      7,
    ...
    _slotEntranceCtrl = AnimationController(
      ...
      duration: const Duration(
        milliseconds: 1600,
      ), // Yuvaların gelme süresini uzattık (daha soft)
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _premiumInfoRow(
                          Icons.auto_awesome,
                          _isTr
                              ? "Full Arcana derin okuması için giriş izni"
                              : "Access to Full Arcana deep reading",
                          true,
                        ),
                        ...
                        _premiumInfoRow(
                          Icons.diamond_outlined,
                          _isTr
                              ? "Her okuma 1 Ruh Taşı harcar"
                              : "Each reading costs 1 Soul Stone",
                          soulStones >= 1,
                        ),
                        const SizedBox(height: 10),
                        _premiumInfoRow(
                          ...
                          _isTr
                              ? "Elite ile günlük 5 Ruh Taşı"
                              : "5 daily Soul Stones with Elite",
                          false,
                        ),
  ...
  Future<void> _commitAndReveal() async {
    ...
    final category =
        (_selectedCategory != null && _selectedCategory! < deckTypes.length)
        ? deckTypes[_selectedCategory!]
        : 'Genel';
    for (final idx in _selectedCardIndexes) {
      final name = _cardName(idx);
      final asset = _allCards[idx].frontAsset;
      await UserStatsService.addTarotReading(
        name,
        category,
        '',
        cardAsset: asset,
    ...
    return Padding(
      ...
      child: GlassCard(
        ...
        settings: const LiquidGlassSettings(
          ...
          glassColor: Color(
            0x1AE7D6A5,
          ), // Çok hafif sıcak/altın bir renk tonu (%10 opacity)
          chromaticAberration: 0.15,
          lightIntensity:
              1.2, // Işık yansımasını artırdık, hafif bir parlama yaratıyor
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: List.generate(7, (i) {
                      ...
                      final dotAnim = ((anim - dotDelay) / (1 - dotDelay))
                          .clamp(0.0, 1.0);
                      return Transform.scale(
            ...
            child: SingleChildScrollView(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    _harmonyColorChip(
                      _isTr ? 'Major Arcana' : 'Major Arcana',
                      const Color(0xFFE7D6A5),
                    ),
                    _harmonyColorChip(
                      _isTr ? 'Asalar (Ateş)' : 'Wands (Fire)',
                      const Color(0xFFE8A07C),
                    ),
                    _harmonyColorChip(
                      _isTr ? 'Kupalar (Su)' : 'Cups (Water)',
                      const Color(0xFF8CB8D4),
                    ),
                    _harmonyColorChip(
                      _isTr ? 'Kılıçlar (Hava)' : 'Swords (Air)',
                      const Color(0xFFB9A0D2),
                    ),
                    _harmonyColorChip(
                      _isTr ? 'Tılsımlar (Toprak)' : 'Pentacles (Earth)',
                      const Color(0xFF9EC8A0),
                    ),
                  ],
                ),
                const SizedBox(height: 20),
    ...
    final levels = _isTr
        ? [
            [
              '90-100',
              'Mükemmel Uyum',
              'Kartlarınız kusursuz bir enerji akışı içinde.',
            ],
            ['70-89', 'Güçlü Uyum', 'Kartlar arasında güçlü bağlantılar var.'],
            [
              '50-69',
              'Dengeli',
              'Kartlar genel olarak uyumlu, bazı gerilimler mevcut.',
            ],
            [
              '30-49',
              'Karışık Enerji',
              'Çelişkili enerjiler; büyüme fırsatları barındırır.',
            ],
        ...
        : [
            [
              '90-100',
              'Perfect Harmony',
              'Your cards flow in perfect energy alignment.',
            ],
            [
              '70-89',
              'Strong Harmony',
              'Strong connections between your cards.',
            ],
            ['50-69', 'Balanced', 'Generally harmonious with some tensions.'],
            [
              '30-49',
              'Mixed Energy',
              'Conflicting energies; growth opportunities.',
            ],
            [
              '0-29',
              'Chaotic',
              'Strong conflicts; high transformation potential.',
            ],
          ];
    return levels
        .map(
  ...
  Widget _buildElementAnalysisPanel(ElementAnalysis analysis) {
    ...
    switch (analysis.dominantElement) {
      ...
      case 'Su':
        ...
        break;
      case 'Hava':
        accentColor = airColor;
        break;
      case 'Toprak':
        accentColor = earthColor;
        break;
      default:
        accentColor = const Color(0xFFE7D6A5);
    }

    final elementData = [
      {
        'name': _isTr ? 'Ateş' : 'Fire',
        'element': 'fire',
        'value': analysis.elements['Ateş'] ?? 0.0,
        'color': fireColor,
      },
      {
        'name': _isTr ? 'Su' : 'Water',
        'element': 'water',
        'value': analysis.elements['Su'] ?? 0.0,
        'color': waterColor,
      },
      {
        'name': _isTr ? 'Hava' : 'Air',
        'element': 'air',
        'value': analysis.elements['Hava'] ?? 0.0,
        'color': airColor,
      },
      {
        'name': _isTr ? 'Toprak' : 'Earth',
        'element': 'earth',
        'value': analysis.elements['Toprak'] ?? 0.0,
        'color': earthColor,
      },
    ];
          ...
          child: Column(
            ...
            children: [
              ...
              ...elementData.map((e) {
                ...
                final isDominant =
                    (e['name'] as String).contains(analysis.dominantElement) ||
                    (analysis.dominantElement == 'Ateş' &&
                        (e['name'] as String).contains('Fire')) ||
                    (analysis.dominantElement == 'Su' &&
                        (e['name'] as String).contains('Water')) ||
                    (analysis.dominantElement == 'Hava' &&
                        (e['name'] as String).contains('Air')) ||
                    (analysis.dominantElement == 'Toprak' &&
                        (e['name'] as String).contains('Earth'));
                return Padding(
              ...
              Container(
                ...
                child: Text(
                  _isTr
                      ? analysis.dominantDescriptionTr
                      : analysis.dominantDescriptionEn,
                  style: TextStyle(
  ...
  String _detectCardSuit(String cardName) {
    ...
    if (lower.contains('asa') ||
        lower.contains('wand') ||
        lower.contains('rod'))
      return 'wands';
    if (lower.contains('kupa') ||
        lower.contains('cup') ||
        lower.contains('chalice'))
      return 'cups';
    if (lower.contains('kılıç') ||
        lower.contains('sword') ||
        lower.contains('blade'))
      return 'swords';
    if (lower.contains('pentakl') ||
        lower.contains('pentacle') ||
        lower.contains('coin') ||
        lower.contains('disk'))
      return 'pentacles';
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Text(
                    '✧',
                    style: TextStyle(
                      color: softGold.withValues(alpha: 0.3),
                      fontSize: 13,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Text(
                    '✦',
                    style: TextStyle(
                      color: warmBeige.withValues(alpha: 0.25),
                      fontSize: 11,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Text(
                    '✦',
                    style: TextStyle(
                      color: warmBeige.withValues(alpha: 0.22),
                      fontSize: 11,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Text(
                    '✧',
                    style: TextStyle(
                      color: softGold.withValues(alpha: 0.28),
                      fontSize: 13,
                    ),
                  ),
                ),
                ...
                Positioned(
                  ...
                  child: Text(
                    '·',
                    style: TextStyle(
                      color: softGold.withValues(alpha: 0.25),
                      fontSize: 10,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Text(
                    '⋆',
                    style: TextStyle(
                      color: creamWhite.withValues(alpha: 0.12),
                      fontSize: 9,
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Text(
                    '⊹',
                    style: TextStyle(
                      color: warmBeige.withValues(alpha: 0.15),
                      fontSize: 7,
                    ),
                  ),
                ),
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              '⟡',
                              style: TextStyle(
                                color: softGold.withValues(alpha: 0.35),
                                fontSize: 8,
                              ),
                            ),
                          ),
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(
                  0xFFE7D6A5,
                ).withOpacity(_magicBtnPressed ? 0.25 : 0.08),
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _isPremiumUser
                            ? const Color(0xFFE2C48E).withOpacity(0.35)
                      ...
                      children: [
                        ...
                        if (_isPremiumUser) ...[
                          _creditInfoRow(
                            Icons.star_border,
                            isTr
                                ? "Günlük $_kMaxPremiumReads Major Arcana hakkı"
                                : "$_kMaxPremiumReads daily Major Arcana reads",
                            true,
                          ),
                          const SizedBox(height: 10),
                          _creditInfoRow(
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    _dailyAdWatchCount < _kMaxDailyAds
                                    ? const Color(0xFFE2C48E).withOpacity(0.15)
                                    : Colors.white.withOpacity(0.05),
                                elevation: 0,
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(16),
                                  side: BorderSide(
                                    color: _dailyAdWatchCount < _kMaxDailyAds
                                        ? const Color(
                                            0xFFE2C48E,
                                          ).withOpacity(0.4)
                                        : Colors.white.withOpacity(0.1),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _premiumInfoRow(
                          Icons.auto_awesome,
                          _isTr
                              ? "Full Arcana derin okuması için gerekli"
                              : "Required for Full Arcana deep reading",
                          true,
                        ),
                        const SizedBox(height: 10),
                        _premiumInfoRow(
    ...
    return Column(
      children: [
        ...
        AnimatedSwitcher(
          ...
          child: Text(
            reading.cardReadings[_fullCardPageIndex].positionTitle
                .toUpperCase(),
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, pageIndex) {
              ...
              final symbolCount = getSymbolCountForPosition(
                pageIndex,
                symbols.length,
              );
              ...
              final symbolRng = Random(
                cardId * 1000 + DateTime.now().day * 31 + DateTime.now().hour,
              );
              ...
              const imgRenderedW =
                  240.0; // square image → rendered width = height
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, _) {
                              ...
                              final t = Curves.easeOutCubic.transform(
                                _infoRevealCtrl!.value,
                              );
                              final labelOpacity = ((t - 0.25) / 0.75).clamp(
                                0.0,
                                1.0,
                              );
                              return Opacity(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _isTr
                                          ? s.meaningTr(symbolRng)
                                          : s.meaningEn(symbolRng),
                                      textAlign: TextAlign.right,
                                      maxLines: 2,
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                      ...
                      children: [
                                ...
                                child: IgnorePointer(
                                  child: AnimatedBuilder(
                                    ...
                                    builder: (context, child) {
                                      ...
                                      final lineProgress = (t / 0.35).clamp(
                                        0.0,
                                        1.0,
                                      );
                                      return Opacity(
                                        ...
                                        child: CustomPaint(
                                          painter: _InfographicLinePainter(
                                            linePoints,
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            ...
                            final nameOpacity = ((t - 0.35) / 0.65).clamp(
                              0.0,
                              1.0,
                            );
                            return Opacity(
                              ...
                              child: Text(
                                _isTr
                                    ? _allCards[cardId].nameTr
                                    : _allCards[cardId].nameEn,
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 16,
                                  fontWeight: FontWeight.w700,
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            ...
                            final contentOpacity = ((t - 0.45) / 0.55).clamp(
                              0.0,
                              1.0,
                            );
                            return Opacity(
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  padding: EdgeInsets.fromLTRB(
                    ...
                    24,
                    0,
                    40 + MediaQuery.of(ctx).padding.bottom,
                  ),
                  child: Column(
                    children:
                        [
                                      ...
                                      children: [
                                        ...
                                        Transform.translate(
                                          ...
                                          child: Transform.rotate(
                                            angle: -0.25,
                                            child: _buildHeroCardView(
                                              _selectedCardIndexes[0],
                                              colors[0],
                                              0.85,
                                            ),
                                          ),
  ...
  Future<void> _animateCardToSlot(
    GlobalKey fromKey,
    GlobalKey toKey,
    int tablePosition,
  ) async {
    ...
    entry = OverlayEntry(
      builder: (_) {
        ...
        final w =
            ui.lerpDouble(fromSize.width, toSize.width, t) ?? fromSize.width;
        final h =
            ui.lerpDouble(fromSize.height, toSize.height, t) ?? fromSize.height;
  ...
  static List<Color> _cardGradient(int id) {
    if (id < 22) {
      ...
      return [
        const Color(0xFF4A3578),
        const Color(0xFF352660),
        const Color(0xFF261B4A),
      ];
    }
    ...
    switch (suitIdx) {
      case 0:
        return [
          const Color(0xFF354A78),
          const Color(0xFF263560),
          const Color(0xFF1B264A),
        ]; // Cups - soft blue
      case 1:
        return [
          const Color(0xFF785035),
          const Color(0xFF603A26),
          const Color(0xFF4A2D1B),
        ]; // Wands - warm
      case 2:
        return [
          const Color(0xFF484858),
          const Color(0xFF363645),
          const Color(0xFF282835),
        ]; // Swords - cool grey
      default:
        return [
          const Color(0xFF357848),
          const Color(0xFF266035),
          const Color(0xFF1B4A28),
        ]; // Pentacles - sage
    }
  }
  ...
  static Color _cardAccent(int id) {
    ...
    switch (suitIdx) {
      case 0:
        return const Color(0xFF6CA6D4); // blue
      case 1:
        return const Color(0xFFD4976C); // amber
      case 2:
        return const Color(0xFFA0A0B8); // silver
      default:
        return const Color(0xFF6CD49C); // green
    }
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Wrap(
                ...
                children: List.generate(78, (i) {
                  final cardIndex =
                      _tableCards.isNotEmpty && i < _tableCards.length
                      ? _tableCards[i]
                      : i;
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              gradient: const LinearGradient(
                                ...
                                colors: [Color(0xFF2A1F4E), Color(0xFF1A0F2E)],
                              ),
                              border: Border.all(
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [buildCatCard(0), buildCatCard(1), buildCatCard(2)],
          ),
          const SizedBox(height: 10),
          // Bottom row: 2 categories
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [buildCatCard(3), buildCatCard(4)],
          ),
        ],
      ),
    );
  ...
  Widget _buildCardFront(int cardIdx) {
    ...
    return ClipRRect(
      ...
      child: Transform.scale(
        scale: 1.12,
        child: Image.asset(frontAsset, fit: BoxFit.cover),
      ),
    );
  }
        ...
        body: Stack(
          children: [
            Positioned.fill(
              child: AnimatedBuilder(
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            0.15 + sin(bv * pi * 2) * 0.15,
                            -0.55 + cos(bv * pi * 2) * 0.10,
                          ),
                          radius: 0.6,
                          colors: [
                            Color.fromRGBO(
                              (150 + sin(bv * pi * 2) * 40).round().clamp(
                                0,
                                255,
                              ),
                              (64 + cos(bv * pi * 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (100 + sin(bv * pi * 2 + 1) * 35).round().clamp(
                                0,
                                255,
                              ),
                              0.45 + sin(bv * pi * 2) * 0.10,
                            ),
                            Color.fromRGBO(
                              (120 + sin(bv * pi * 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (50 + cos(bv * pi * 2) * 20).round().clamp(
                                0,
                                255,
                              ),
                              90,
                              0.25 + sin(bv * pi * 2) * 0.05,
                            ),
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            -0.30 + sin(bv * pi * 2 + 1.5) * 0.12,
                            -0.40 + cos(bv * pi * 2 + 1.5) * 0.08,
                          ),
                          radius: 0.55,
                          colors: [
                            Color.fromRGBO(
                              (180 + cos(bv * pi * 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (160 + sin(bv * pi * 2 + 2) * 40).round().clamp(
                                0,
                                255,
                              ),
                              (210 + cos(bv * pi * 2 + 1) * 25).round().clamp(
                                0,
                                255,
                              ),
                              0.28 + sin(bv * pi * 2 + 1.5) * 0.08,
                            ),
                            Color.fromRGBO(
                              160,
                              (140 + sin(bv * pi * 2) * 25).round().clamp(
                                0,
                                255,
                              ),
                              190,
                              0.14 + sin(bv * pi * 2 + 1.5) * 0.04,
                            ),
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            0.05 + sin(bv * pi * 2 + 0.8) * 0.12,
                            0.05 + cos(bv * pi * 2 + 0.8) * 0.10,
                          ),
                          radius: 0.75,
                          colors: [
                            Color.fromRGBO(
                              (120 + cos(bv * pi * 2 + 0.5) * 35).round().clamp(
                                0,
                                255,
                              ),
                              (55 + sin(bv * pi * 2 + 1.5) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (110 + cos(bv * pi * 2) * 40).round().clamp(
                                0,
                                255,
                              ),
                              0.48 + sin(bv * pi * 2 + 0.8) * 0.08,
                            ),
                            Color.fromRGBO(
                              100,
                              (45 + cos(bv * pi * 2) * 20).round().clamp(
                                0,
                                255,
                              ),
                              (95 + sin(bv * pi * 2 + 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              0.28 + sin(bv * pi * 2 + 0.8) * 0.06,
                            ),
                            Color.fromRGBO(
                              75,
                              35,
                              80,
                              0.12 + sin(bv * pi * 2 + 0.8) * 0.03,
                            ),
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            -0.25 + sin(bv * pi * 2 + 2.5) * 0.15,
                            0.35 + cos(bv * pi * 2 + 2.5) * 0.10,
                          ),
                          radius: 0.65,
                          colors: [
                            Color.fromRGBO(
                              (42 + sin(bv * pi * 2 + 1) * 25).round().clamp(
                                0,
                                255,
                              ),
                              (55 + cos(bv * pi * 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (108 + sin(bv * pi * 2 + 2) * 35).round().clamp(
                                0,
                                255,
                              ),
                              0.40 + sin(bv * pi * 2 + 2.5) * 0.08,
                            ),
                            Color.fromRGBO(
                              38,
                              48,
                              95,
                              0.18 + sin(bv * pi * 2 + 2.5) * 0.03,
                            ),
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            0.7 + sin(bv * pi * 2 + 3.8) * 0.10,
                            -0.6 + cos(bv * pi * 2 + 3.8) * 0.08,
                          ),
                          radius: 0.55,
                          colors: [
                            Color.fromRGBO(
                              (85 + cos(bv * pi * 2 + 2) * 30).round().clamp(
                                0,
                                255,
                              ),
                              (55 + sin(bv * pi * 2) * 25).round().clamp(
                                0,
                                255,
                              ),
                              (140 + cos(bv * pi * 2 + 1) * 30).round().clamp(
                                0,
                                255,
                              ),
                              0.22 + sin(bv * pi * 2 + 3.8) * 0.06,
                            ),
                  ...
                  child: IgnorePointer(
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: RadialGradient(
                          center: Alignment(
                            -0.7 + sin(bv * pi * 2 + 5.0) * 0.12,
                            0.8 + cos(bv * pi * 2 + 5.0) * 0.08,
                          ),
                          radius: 0.5,
                          colors: [
                            Color.fromRGBO(
                              (26 + sin(bv * pi * 2) * 15).round().clamp(
                                0,
                                255,
                              ),
                              (20 + cos(bv * pi * 2 + 1) * 10).round().clamp(
                                0,
                                255,
                              ),
                              (64 + sin(bv * pi * 2 + 2) * 20).round().clamp(
                                0,
                                255,
                              ),
                              0.50,
                ...
                Positioned.fill(
                  child: RepaintBoundary(
                    child: IgnorePointer(
                      child: CustomPaint(painter: _StarFieldPainter(pulse: bv)),
                    ),
                  ),
                ),
                ...
                Positioned.fill(
                  child: RepaintBoundary(
                    child: IgnorePointer(
                      child: CustomPaint(painter: _BokehPainter(pulse: bv)),
                    ),
                  ),
                ),
                ...
                Positioned.fill(
                  child: RepaintBoundary(
                    child: IgnorePointer(
                      child: CustomPaint(painter: _StarDustPainter(pulse: bv)),
                    ),
                  ),
                ),
                ...
                ...List.generate(6, (i) {
                  ...
                  final opacity = (0.08 + sin(bv * pi * 2 + seed * 0.3) * 0.06)
                      .clamp(0.0, 1.0);
                    ...
                    child: Opacity(
                      ...
                      child: Transform.rotate(
                        ...
                        child: SizedBox(
                          width: 280,
                          height: 280,
                          child: CustomPaint(painter: _SacredGeometryPainter()),
                        ),
                      ),
                    ),
                  ),
                  ...
                  child: IgnorePointer(
                    child: ShaderMask(
                      ...
                      child: Opacity(
                        ...
                        child: CustomPaint(painter: _GoldenBorderPainter()),
                      ),
                    ),
                  ),
                ),
                                        ...
                                        decoration: BoxDecoration(
                                          gradient: RadialGradient(
                                            center: const Alignment(
                                              0,
                                              -0.2,
                                            ), // Ekranın hafif üst merkezinden
                                            radius:
                                                1.2 +
                                                pulse *
                                                    0.1, // Nefes alarak büyüyüp küçülen
                                            colors: [
                                              auraColor1,
                                              auraColor2,
                                              Colors.transparent,
            ...
            SafeArea(
                  child: AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      if (_readingScrollCtrl.hasClients) {
                        offset = _readingScrollCtrl.offset.clamp(
                          0.0,
                          double.infinity,
                        );
                      }
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Opacity(
                                opacity: _state == RitualState.revealed
                                    ? 0.0
                                    : 1.0,
                                child: IgnorePointer(
                                    ...
                                    child: Align(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          _TapScaleButton(
                                            onTap: _isBuyukArkana
                                                ? _showCreditInfoPanel
                                              ...
                                              child: BackdropFilter(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: FutureBuilder<int>(
                                                    future: _isBuyukArkana
                                                        ? Future.value(0)
                                                        : StorageService.getSoulStones(),
                                                    builder: (ctx, snap) {
                                                      if (_isBuyukArkana) {
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (_, __) {
                            ...
                            if (selected == 0) {
                              ...
                              subtitle = _t(
                                '$selected / $max kart seçildi',
                                '$selected / $max cards selected',
                              );
                            } else {
                                      ...
                                      children: [
                                        ...
                                        Stack(
                                          ...
                                          children: [
                                            ...
                                            _FloatingTarotDeck(
                                              key: ValueKey(
                                                'deck_${_isBuyukArkana ? "b" : "t"}_$_deckRebuildKey',
                                              ),
                                              onCardTap: _selectCard,
                                              cardBuilder:
                                                  (int idx, int total) =>
                                                      _tarotCard(idx, total),
                                              cardKeys: _cardKeys.sublist(
                                                0,
                                                _tableCount,
                                              ),
                                              selectedPositions:
                                                  _selectedTablePositions,
                                          ...
                                          child: AnimatedBuilder(
                                            ...
                                            builder: (_, __) {
                                              return Opacity(
                                                ...
                                                child: Text(
                                                  _t(
                                                    'Bir kart seç veya rastgele çek',
                                                    'Pick a card or shuffle',
                                                  ),
                                                  style: const TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 12,
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  TweenAnimationBuilder<double>(
                                    tween: Tween<double>(
                                      begin: 0.0,
                                      end: _state == RitualState.revealed
                                          ? 1.0
                                          : 0.0,
                                    ),
                                    duration: const Duration(
                                        ...
                                        SizedBox(
                                          ...
                                          child: AnimatedBuilder(
                                            ...
                                            builder: (_, __) {
                                              ...
                                              final slotLabels = _isBuyukArkana
                                                  ? slotLabels3
                                                  : slotLabels7;
                                              final slotSymbols3 = [
                                              ...
                                              final symbols = _isBuyukArkana
                                                  ? slotSymbols3
                                                  : slotSymbols7;
                                              final cardW = _isBuyukArkana
                                                  ? 88.0
                                                  : 70.0;
                                              final cardH = _isBuyukArkana
                                                  ? 138.0
                                                  : 105.0;
                                              final topCount = _isBuyukArkana
                                                  ? 3
                                                  : 4;
                                              final bottomCount = _isBuyukArkana
                                                  ? 0
                                                  : 3;
                                              ...
                                              Widget buildSlot(int i) {
                                                ...
                                                final scaleT = Curves
                                                    .easeOutQuint
                                                    .transform(rawT);
                                                final fadeT = Curves.easeOutQuad
                                                    .transform(rawT);
                                                final slideY =
                                                    (1.0 - fadeT) * 12.0;
                ...
                if (_state == RitualState.revealed &&
                    (_latestReading != null || _latestFullReading != null))
                  Positioned.fill(
                    child: TweenAnimationBuilder<double>(
                      tween: Tween<double>(begin: 0.0, end: 1.0),
                                          ...
                                          if (_latestReading != null) ...[
                                            _buildReadingSection(
                                                  title: _isTr
                                                      ? 'Geçmiş'
                                                      : 'Past',
                                                  content: _latestReading!
                                                      .pastInfluence,
                                                  cardName: _cardName(
                                                    _selectedCardIndexes[0],
                                                  ),
                                                  cardAsset:
                                                      _allCards[_selectedCardIndexes[0]]
                                                          .frontAsset,
                                            ...
                                            _buildReadingSection(
                                                  ...
                                                  cardAsset:
                                                      _allCards[_selectedCardIndexes[1]]
                                                          .frontAsset,
                                            ...
                                            _buildReadingSection(
                                                  ...
                                                  cardAsset:
                                                      _allCards[_selectedCardIndexes[2]]
                                                          .frontAsset,
                                                  icon: Icons.explore,
                                                  color: const Color(
                                                    0xFFE7D6A5,
...
class _FloatingTarotDeckState extends State<_FloatingTarotDeck>
  ...
  int? _hitTestCard(Offset localPos) {
    ...
    final double inflation =
        0.0; // Enflasyonu sıfırladık, böylece Majör Arkana'da da yandaki karta taşmıyor

    // Reverse iterate so top-drawn cards get priority
    for (int i = totalCards - 1; i >= 0; i--) {
      final hb = _cardHitboxes[i];
      if (hb == null) continue;
      if (widget.selectedPositions.contains(i) ||
          widget.hiddenCards.contains(i))
        continue;
            ...
            return LayoutBuilder(
              builder: (context, constraints) {
                ...
                Widget buildCard(
                  ...
                  final isSelected =
                      widget.selectedPositions.contains(cardIdx) ||
                      widget.hiddenCards.contains(cardIdx);
                  // Staggered delay: right to left (reverse index)
                  final reverseIdx = totalCards - 1 - cardIdx;
                  final delay = (reverseIdx / totalCards) * 0.5;
                  final cardT = ((entranceT - delay) / (1.0 - delay)).clamp(
                    0.0,
                    1.0,
                  );
                ...
                for (int layer = 0; layer < layerCount; layer++) {
                  ...
                  for (int i = 0; i < count; i++) {
                    ...
                    final floatY = isSmall
                        ? 0.0
                        : sin(_controller.value * 2 * pi + cardIdx * 0.5) *
                                  4.0 +
                              (isSmall
                                  ? 0.0
                                  : sin(
                                          _controller.value * 2 * pi * 2 +
                                              cardIdx * 0.8,
                                        ) *
                                        2.0);
                    final floatX = isSmall
                        ? 0.0
                        : cos(_controller.value * 2 * pi + cardIdx * 0.6) * 2.5;

                    final x =
                        centerX + cos(angleRad) * radius - (cardW / 2) + floatX;
                    final y =
                        centerY + sin(angleRad) * radius - (cardH / 2) + floatY;
                      ...
                      child: Transform.scale(
                        ...
                        child: GestureDetector(
                          ...
                          onTapUp: (_) async {
                            ...
                            final available =
                                List.generate(totalCards, (i) => i)
                                    .where(
                                      (i) =>
                                          !widget.selectedPositions.contains(
                                            i,
                                          ) &&
                                          !widget.hiddenCards.contains(i),
                                    )
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final band in bands) {
      ...
      for (double x = 0; x <= size.width; x += 6) {
        final wave1 =
            sin((x / size.width) * pi * freq + pulse * pi * 2 * 0.4 + ph) * amp;
        final wave2 =
            sin(
              (x / size.width) * pi * (freq * 1.7) +
                  pulse * pi * 2 * 0.25 +
                  ph * 1.5,
            ) *
            amp *
...
class _BokehPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      switch (colorChoice) {
        case 0:
          baseColor = const Color(0xFFE2C48E);
          break;
        case 1:
          baseColor = const Color(0xFFB388FF);
          break;
        default:
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 12; i++) {
      ...
      canvas.drawCircle(
        ...
        1.5,
        Paint()
          ..color = const Color(0xFFE2C48E).withOpacity(0.5)
...
class _TarotSymbolPainter extends CustomPainter {
  ...
  void _drawMajor(
    ...
    switch (id) {
      ...
      case 2: // High Priestess - crescents
        canvas.drawArc(
          Rect.fromCircle(center: Offset(cx - 4, cy), radius: r * 0.7),
          -pi / 2,
          pi,
          false,
          p,
      ...
      case 8: // Strength - infinity + circle
        ...
        for (double t = 0; t < 2 * pi; t += 0.05) {
          ...
          final y =
              (cy - r * 0.5) +
              r * 0.25 * sin(t) * cos(t) / (1 + sin(t) * sin(t));
          if (t == 0)
            inf.moveTo(x, y);
          else
            inf.lineTo(x, y);
      ...
      case 10: // Wheel - spoked circle
        ...
        for (int i = 0; i < 8; i++) {
          final a = i * pi / 4;
          canvas.drawLine(
            Offset(cx + cos(a) * r * 0.35, cy + sin(a) * r * 0.35),
            Offset(cx + cos(a) * r * 0.85, cy + sin(a) * r * 0.85),
            p,
          );
        }
      case 11: // Justice - scales
        ...
        canvas.drawArc(
          Rect.fromCircle(center: Offset(cx - r * 0.7, cy), radius: r * 0.3),
          0,
          pi,
          false,
          p,
      ...
      case 19: // Sun - circle with rays
        ...
        for (int i = 0; i < 12; i++) {
          final a = i * pi / 6;
          canvas.drawLine(
            Offset(cx + cos(a) * r * 0.5, cy + sin(a) * r * 0.5),
            Offset(cx + cos(a) * r * 0.85, cy + sin(a) * r * 0.85),
            p,
          );
        }
  ...
  void _drawStar(
    ...
    for (int i = 0; i < points * 2; i++) {
      ...
      if (i == 0)
        path.moveTo(cx + cos(a) * sr, cy + sin(a) * sr);
      else
        path.lineTo(cx + cos(a) * sr, cy + sin(a) * sr);
    }
    path.close();
    canvas.drawPath(path, p);
  }
  ...
  void _drawPentagram(
    ...
    for (int i = 0; i < 5; i++) {
      ...
      if (i == 0)
        path.moveTo(cx + cos(a) * r, cy + sin(a) * r);
      else
  ...
  @override
  bool shouldRepaint(covariant _TarotSymbolPainter old) =>
...
class _CardStarPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _CardStarPainter oldDelegate) =>
...
class _WaveDiamondPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    leftPath.cubicTo(
      leftStart - 20,
      centerY + 8, // control point 1 - dip down
      leftStart - 45,
      centerY - 6, // control point 2 - curve up
      leftStart - 70,
      centerY, // end point
    );
              ...
              child: Stack(
                children: [
                  ...
                  Center(
                    child: Text(
                      _watching
                          ? '⏳ ${(2 - _ctrl.value * 2).toStringAsFixed(0)}s...'
                          : widget.label,
                      style: TextStyle(
...
class _CardPairSymbolPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    switch (shape) {
      case 0: // İç içe hilaller
        final left = Path()
          ..addArc(
            Rect.fromCircle(center: Offset(cx - 1.5, cy), radius: r),
            pi * 0.6,
            pi * 1.8,
          );
        final right = Path()
        ...
        canvas.drawCircle(
          ...
          2,
          Paint()
            ..color = blended.withValues(alpha: 0.6)
            ..style = PaintingStyle.fill,
        );
      ...
      case 1: // Daire + iç üçgen
        ...
        canvas.drawCircle(
          ...
          2,
          Paint()
            ..color = blended.withValues(alpha: 0.5)
            ..style = PaintingStyle.fill,
        );
        canvas.drawCircle(Offset(cx, cy), 4, glow);
        break;
      ...
      case 3: // Elmas + yatay göz
        ...
        canvas.drawLine(
          ...
          Offset(cx + r * 0.6, cy),
          Paint()
            ..color = blended.withValues(alpha: 0.35)
            ..strokeWidth = 0.8,
        );
        canvas.drawCircle(
          Offset(cx, cy),
      ...
      case 4: // Çiçek — 6 yaprak
        for (var i = 0; i < 6; i++) {
          ...
          petal.quadraticBezierTo(
            cx + r * 0.5 * cos(angle - 0.4),
            cy + r * 0.5 * sin(angle - 0.4),
            cx + r * 0.8 * cos(angle),
            cy + r * 0.8 * sin(angle),
          );
          petal.quadraticBezierTo(
          ...
          canvas.drawPath(
            petal,
            stroke..color = blended.withValues(alpha: 0.5 + (i % 2) * 0.2),
          );
        }
        canvas.drawCircle(
          Offset(cx, cy),
      ...
      case 5: // Rün haçı — dört kol + köşe noktaları
        canvas.drawLine(
          Offset(cx, cy - r),
          Offset(cx, cy + r),
          stroke..color = blended.withValues(alpha: 0.7),
        );
        canvas.drawLine(
          Offset(cx - r, cy),
          Offset(cx + r, cy),
      ...
      case 7: // Ankh — üst halka + dikey çizgi + yatay kol
        ...
        canvas.drawLine(
          ...
          Offset(cx + r * 0.55, cy + r * 0.15),
          stroke..color = blended.withValues(alpha: 0.6),
        );
        canvas.drawCircle(
          Offset(cx, cy - r * 0.35),
          1.5,
  ...
  bool shouldRepaint(covariant _CardPairSymbolPainter old) =>
      suit1 != old.suit1 ||
      suit2 != old.suit2 ||
      card1Name != old.card1Name ||
      card2Name != old.card2Name;
}
...
class _MysticalEyePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      eyeShape,
      Paint()
        ..color = color.withValues(alpha: 0.06 + 0.06 * openness)
        ..style = PaintingStyle.fill,
    );
    canvas.drawPath(
      upperLid,
      Paint()
        ..color = color.withValues(alpha: 0.5 + 0.4 * openness)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.2
        ..strokeCap = StrokeCap.round,
    );
    canvas.drawPath(
      lowerLid,
      Paint()
        ..color = color.withValues(alpha: 0.4 + 0.3 * openness)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.0
        ..strokeCap = StrokeCap.round,
    );
    ...
    if (openness > 0.15) {
      ...
      canvas.drawCircle(
        ...
        irisR,
        Paint()
          ..color = color.withValues(alpha: 0.15 + 0.15 * openness)
          ..style = PaintingStyle.fill,
      );
      canvas.drawCircle(
        Offset(cx, cy),
      ...
      if (openness > 0.4) {
        for (var i = 0; i < 8; i++) {
          ...
          canvas.drawLine(
            Offset(cx + innerR * cos(angle), cy + innerR * sin(angle)),
            Offset(
              cx + irisR * 0.9 * cos(angle),
              cy + irisR * 0.9 * sin(angle),
            ),
            Paint()
              ..color = color.withValues(alpha: 0.15 * openness)
              ..strokeWidth = 0.4,
          );
        }
      }
      ...
      canvas.drawCircle(
        ...
        pupilR,
        Paint()
          ..color = color.withValues(alpha: 0.7 + 0.3 * openness)
          ..style = PaintingStyle.fill,
      );
      canvas.drawCircle(
        Offset(cx - pupilR * 0.4, cy - pupilR * 0.4),
        pupilR * 0.3,
        Paint()
          ..color = Colors.white.withValues(alpha: 0.5 * openness)
          ..style = PaintingStyle.fill,
      );
    }
  ...
  @override
  bool shouldRepaint(covariant _MysticalEyePainter old) =>
...
class _ConstellationPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final activeConnections = (score * connections.length).round().clamp(
      0,
      connections.length,
    );
    ...
    for (var i = 0; i < activeConnections; i++) {
      ...
      canvas.drawLine(
        ...
        to,
        Paint()
          ..color = color.withValues(alpha: 0.25 + 0.15 * score)
          ..strokeWidth = 0.8
          ..strokeCap = StrokeCap.round,
      );
    }
    ...
    for (var i = 0; i < stars.length; i++) {
      ...
      if (isActive) {
        ...
        canvas.drawCircle(
          ...
          2.5,
          Paint()
            ..color = color.withValues(alpha: 0.7 + 0.3 * score)
            ..style = PaintingStyle.fill,
        );
        canvas.drawCircle(
          pos,
          1,
          Paint()
            ..color = Colors.white.withValues(alpha: 0.5 * score)
            ..style = PaintingStyle.fill,
        );
        if (score > 0.5) {
          final rayLen = 2.0 + 2.0 * score;
          final rayPaint = Paint()
            ..color = color.withValues(alpha: 0.2 * score)
            ..strokeWidth = 0.4
            ..strokeCap = StrokeCap.round;
          canvas.drawLine(
...
class _HarmonyWavesPainter extends CustomPainter {
    ...
    if (harmony > 0.85) {
      ...
      for (var i = 0; i < 3; i++) {
        ...
        canvas.drawCircle(
          ...
          2.5,
          Paint()
            ..color = color.withValues(alpha: 0.4 * sparkAlpha)
            ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 2)
            ..style = PaintingStyle.fill,
        );
        canvas.drawCircle(
          ...
          1.5,
          Paint()
            ..color = color.withValues(alpha: 0.7 * sparkAlpha)
            ..style = PaintingStyle.fill,
        );
      }
    }
  ...
  @override
  bool shouldRepaint(covariant _HarmonyWavesPainter old) =>
      harmony != old.harmony;
}
...
class _HarmonySymbolPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      ...
      outerR,
      Paint()
        ..color = blended.withValues(alpha: 0.15 + 0.15 * harmony)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.0,
    );
    ...
    canvas.drawOval(
      ...
      Paint()
        ..color = blended.withValues(alpha: 0.10 + 0.10 * harmony)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 0.7,
    );
    canvas.restore();
    ...
    if (harmony > 0.4) {
      ...
      canvas.drawCircle(
        ...
        maxR * 0.5,
        Paint()
          ..color = blended.withValues(alpha: 0.15 * gi)
          ..maskFilter = MaskFilter.blur(BlurStyle.normal, 10 * gi)
          ..style = PaintingStyle.fill,
      );
    }
    ...
    final clipR = Path()
      ...
      ..addOval(
        Rect.fromCircle(center: c2, radius: r2 * (0.82 + 0.18 * (1 - harmony))),
      );
    ...
    canvas.drawCircle(
      ...
      r1,
      Paint()
        ..color = color1.withValues(alpha: 0.25 + 0.25 * harmony)
        ..style = PaintingStyle.fill,
    );
    canvas.restore();
    canvas.drawCircle(
      ...
      r1,
      Paint()
        ..color = color1.withValues(alpha: 0.55 + 0.35 * harmony)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.5 + 0.8 * harmony,
    );
    ...
    final clipL = Path()
      ..addRect(Rect.fromLTWH(0, 0, size.width, size.height))
      ..addOval(
        Rect.fromCircle(center: c1, radius: r1 * (0.78 + 0.22 * (1 - harmony))),
      );
    ...
    canvas.drawCircle(
      ...
      r2,
      Paint()
        ..color = color2.withValues(alpha: 0.20 + 0.30 * harmony)
        ..style = PaintingStyle.fill,
    );
    canvas.restore();
    canvas.drawCircle(
      ...
      r2,
      Paint()
        ..color = color2.withValues(alpha: 0.50 + 0.40 * harmony)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 1.2 + 0.8 * harmony,
    );
    ...
    if (harmony > 0.2) {
      ...
      canvas.drawCircle(
        ...
        innerR,
        Paint()
          ..color = color2.withValues(alpha: 0.18 * ia)
          ..style = PaintingStyle.fill,
      );
      canvas.drawCircle(
        c2,
        innerR,
        Paint()
          ..color = color2.withValues(alpha: 0.55 * ia)
          ..style = PaintingStyle.stroke
          ..strokeWidth = 0.9,
      );
    }
    ...
    if (harmony > 0.15) {
      ...
      canvas.drawCircle(
        ...
        5 * harmony,
        Paint()
          ..color = blended.withValues(alpha: 0.22 * da)
          ..maskFilter = MaskFilter.blur(BlurStyle.normal, 5 * harmony)
          ..style = PaintingStyle.fill,
      );
      canvas.drawCircle(
        Offset(cx, cy),
        2.0 + 1.5 * harmony,
        Paint()
          ..color = blended.withValues(alpha: 0.65 + 0.35 * da)
          ..style = PaintingStyle.fill,
      );
      if (harmony > 0.5) {
        canvas.drawCircle(
    ...
    if (harmony > 0.6) {
      ...
      for (var i = 0; i < 4; i++) {
        ...
        canvas.drawCircle(
          ...
          1.8,
          Paint()
            ..color = mc.withValues(alpha: 0.3 * ma)
        ...
        canvas.drawCircle(
          ...
          1.5,
          Paint()
            ..color = mc.withValues(alpha: 0.55 * ma)
            ..style = PaintingStyle.fill,
        );
      }
    }
  ...
  @override
  bool shouldRepaint(covariant _HarmonySymbolPainter old) =>
      harmony != old.harmony;
}
